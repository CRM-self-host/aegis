...
#   bash scripts/setup-dev-env.sh          # start + configure
#   bash scripts/setup-dev-env.sh --down    # stop services
#   bash scripts/setup-dev-env.sh --reset   # wipe data + restart
#   bash scripts/setup-dev-env.sh --docker  # force Docker mode
# =============================================================================
set -euo pipefail
