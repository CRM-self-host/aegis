...
Thanks for considering contributing to Aegis!

Please make sure to go through the [documentation](https://docs.aegis.com) before.
...
4. **Make Changes:** Make your desired changes and ensure that your code adheres to Aegis's coding standards.
...
8. **Create a Pull Request:** Go to the original Aegis repository and create a pull request. Please provide a detailed description of your changes. Submitting a PR means you agree to the CLA.
...
If you face any issues or have suggestions, please feel free to [create an issue on Aegis's GitHub repository](https://github.com/u84u/aegis/issues/new). Please provide as much detail as possible.
