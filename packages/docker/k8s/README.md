...
See [QUICKSTART](../helm/aegis/QUICKSTART.md) and [chart README](../helm/aegis/README.md) for details.
...
2. Create Server Secret
    ...
    ``` bash
    kubectl create secret generic -n u84u tokens --from-literal accessToken=changeme --from-literal loginToken="changeme" --from-literal refreshToken="changeme" --from-literal fileToken="changeme"
    ```
