...
Deploy Aegis CRM on Kubernetes with server, worker, PostgreSQL, and Redis components.
...
- Database `aegis` and schema `core` are created automatically by server init container
