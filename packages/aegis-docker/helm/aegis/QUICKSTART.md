# Aegis Helm Chart - Quick Install
...
- Create the PostgreSQL database "aegis" and schema "core" automatically
...
```bash
kubectl get secret tokens -n u84u -o jsonpath='{.data.accessToken}' | base64 --decode && echo
```
...
```bash
helm uninstall my-aegis -n u84u
kubectl delete namespace u84u
```
