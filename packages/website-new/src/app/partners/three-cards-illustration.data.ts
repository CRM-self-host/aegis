...
export const THREE_CARDS_ILLUSTRATION_DATA: ThreeCardsIllustrationDataType = {
  ...
  heading: [
    ...
    { text: 'and unlock new opportunities with Aegis', fontFamily: 'sans' },
  ],
  body: { text: '' },
  illustrationCards: [
    {
      ...
      body: {
        text: 'Build integrations that connect Aegis with the tools your customers already use. Help us expand the Aegis ecosystem.',
      },
      benefits: [
        { text: 'Co-marketing opportunities', icon: 'users' },
        { text: 'Listing on Aegis integrations page', icon: 'search' },
    ...
    },
    {
      ...
      body: {
        text: "Share Aegis with your audience and help shape the future of the #1 open source CRM. We're looking for creators, educators, and community builders who want to showcase great software.",
      },
      benefits: [
    ...
    },
    {
      ...
      body: {
        text: 'Help customers implement, customize, and succeed with Aegis. Combine sales and services to grow your business.',
      },
      benefits: [
