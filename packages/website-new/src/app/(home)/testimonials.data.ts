...
export const TESTIMONIALS_DATA: TestimonialsDataType = {
  ...
  testimonials: [
    ...
    {
      heading: {
        text: 'It is just such a nicer experience than dealing with a Salesforce or a HubSpot. My mission has been to get every tool API-accessible, so everything talks to each other. Aegis made that possible in a way older CRM platforms simply do not.',
        fontFamily: 'sans',
      },
      author: {
