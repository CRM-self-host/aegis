...
import { EDITORIAL_FOUR } from '@/app/why-aegis/editorial-four.data';
import { EDITORIAL_ONE } from '@/app/why-aegis/editorial-one.data';
import { EDITORIAL_THREE } from '@/app/why-aegis/editorial-three.data';
import { HERO_DATA } from '@/app/why-aegis/hero.data';
import { MARQUEE_DATA } from '@/app/why-aegis/marquee.data';
import { SIGNOFF_DATA } from '@/app/why-aegis/signoff.data';
...
export default async function WhyAegisPage() {
  ...
  return (
    <>
      ...
      <link
        as="fetch"
        href="/illustrations/why-aegis/hero/hero.glb"
        rel="preload"
      />
      <Menu.Root
      ...
      >
        <Hero.Heading
          ...
          size="xl"
        />
        <Hero.Body body={HERO_DATA.body} page={Pages.WhyAegis} />
        <Hero.WhyAegisVisual />
      </Hero.Root>
      ...
      */}
      ...
      >
        ...
        />
        <Signoff.Body body={SIGNOFF_DATA.body} page={Pages.WhyAegis} />
        <Signoff.Cta>
          <LinkButton
            color="primary"
