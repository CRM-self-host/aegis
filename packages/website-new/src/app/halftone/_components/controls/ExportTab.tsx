...
const DEFAULT_IMAGE_FILE_NAME = 'aegis-logo.svg';
const DEFAULT_IMAGE_LABEL = 'Aegis image';
const REACT_EXPORT_SETTING_OPTIONS: Array<{
  ...
  },
  {
    ...
    description:
      'Wraps the mount node with a StyledVisualMount using @linaria/react and keeps the Aegis-ready mount shape.',
  },
  {
    key: 'includeUseClientDirective',
    label: "Add 'use client'",
    description:
      'Prepends the Next.js client directive so the exported component can be dropped into the Aegis website directly.',
  },
  {
  ...
  },
  {
    ...
    description:
      'Exports both a named component and a default export to match the current Aegis illustration import pattern.',
  },
  {
    key: 'includeRegistryComment',
    label: 'Add Aegis header comment',
    description:
