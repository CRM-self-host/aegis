...
const CASE_STUDY: CaseStudyData = {
  meta: {
    title: 'A CRM that grows with you | NetZero & Aegis',
    description:
      'How NetZero uses Aegis across carbon credits, agricultural products, and franchised industrial systems with a modular CRM and a roadmap toward AI-assisted workflows.',
  },
  hero: {
    readingTime: '8 min',
    title: [
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'With Aegis, when a new need appears, he can address it himself: no developer required, no support ticket.',
      ],
      callout:
    ...
    },
    {
      ...
      paragraphs: [
        "Olivier recognizes that NetZero's current use of Aegis is still relatively simple: workflows and integrations are not yet as deep as he eventually wants, because he prioritized getting foundations right first.",
        'What is planned is significant. NetZero has a data lake, online forms, and multiple internal systems that he wants to connect to Aegis. The pipes are there; the next step is automations that tie them together.',
    ...
    },
    {
      ...
      paragraphs: [
        'While NetZero still runs a second CRM in parallel for WhatsApp-heavy operations with farmers in Brazil, they expect to migrate all of it to Aegis as features and the ecosystem grow. Already, their structured, multinational pipeline is powered by Aegis.',
  ...
  catalogCard: {
    summary:
      'NetZero uses Aegis as a modular CRM across product lines and countries, with a roadmap into AI-assisted workflows.',
    date: '2025',
  },
};
