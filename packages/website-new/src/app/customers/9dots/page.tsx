...
const CASE_STUDY: CaseStudyData = {
  meta: {
    title:
      'Homeseller, WhatsApp, and a CRM built around the business | Nine Dots & Aegis',
    description:
      'How Nine Dots Ventures rebuilt a Singapore real estate agency on Aegis with APIs, n8n, Grafana, and AI on top of 2,000+ WhatsApp messages a day.',
  },
  hero: {
    readingTime: '9 min',
    title: [
    ...
    quote: {
      text: 'Aegis lets us build a CRM around the business and not the business around the CRM.',
      author: 'Mike Babiy',
  ...
  sections: [
    {
      ...
      callout:
        '"Aegis lets us build a CRM around the business and not the business around the CRM." - Mike Babiy, Founder, Nine Dots Ventures',
    },
    {
      type: 'text',
      ...
      paragraphs: [
        "Nine Dots rebuilt Homeseller's operations on Aegis, with a custom data model shaped around their sales flow. Because Aegis is open and everything is accessible via API, they connected it to what the business actually needed: n8n for automated workflows (in-app workflows were not available at that time), Grafana for live dashboards fed from Aegis, and a custom AI layer to parse and extract structured insights from more than 2,000 WhatsApp messages a day.",
      ...
      callout:
        '"Aegis is the heart of the system. Everything branches from it." - Azmat Parveen, Nine Dots Ventures',
    },
    {
      type: 'text',
      eyebrow: 'The result',
  ...
  catalogCard: {
    summary:
      "Nine Dots put Aegis at the center of Homeseller's stack with APIs, automation, and AI on top of WhatsApp-heavy operations.",
    date: 'Jul 2025',
  },
};
