...
export const metadata: Metadata = buildPageMetadata({
  path: '/customers',
  title: 'Customers | Aegis',
  description:
    'Meet the teams running their business on Aegis. Real customer stories on how they shaped the CRM to fit their workflow.',
});

const HERO_HEADING = [
  { text: 'See how teams ', fontFamily: 'serif' as const },
  { text: 'build ', fontFamily: 'serif' as const, newLine: true },
  { text: 'on Aegis', fontFamily: 'sans' as const },
];

const HERO_BODY = {
  text: 'Real stories from real teams about how they shaped Aegis to fit their workflow and accelerated their growth.',
};
