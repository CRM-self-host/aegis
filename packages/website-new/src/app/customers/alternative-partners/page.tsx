...
const CASE_STUDY: CaseStudyData = {
  meta: {
    title:
      'From Salesforce to self-hosted Aegis, powered by AI | Alternative Partners',
    description:
      'How Alternative Partners migrated from Salesforce to self-hosted Aegis using agentic AI in the implementation loop: fast migration, durable ownership.',
  },
  hero: {
    readingTime: '7 min',
    title: [
      { text: 'From Salesforce to ', fontFamily: 'serif' },
      { text: 'self-hosted Aegis', fontFamily: 'sans', newLine: true },
    ],
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Alternative Partners is a consulting firm that moved from Salesforce to a self-hosted Aegis instance. Benjamin Reynolds led the migration. He had already become a Aegis expert implementing Aegis for one of Aegis's first cloud customers.",
