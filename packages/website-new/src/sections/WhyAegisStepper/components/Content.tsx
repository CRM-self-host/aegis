...
export type WhyAegisStepperLayoutMode = 'scroll' | 'swipe';

export type WhyAegisStepperContentProps = {
  activeStepIndex: number;
  body: BodyType[];
  heading: HeadingType;
  layoutMode: WhyAegisStepperLayoutMode;
