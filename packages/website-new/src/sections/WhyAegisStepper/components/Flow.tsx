...
import { Logo as WhyAegisStepperLogo } from '@/sections/WhyAegisStepper/visuals/Logo';
import type { WhyAegisStepperDataType } from '@/sections/WhyAegisStepper/types';
...
type FlowProps = WhyAegisStepperDataType;
