...
export const CASE_STUDY_CATALOG_ENTRIES: CaseStudyCatalogEntry[] = [
  ...
  },
  {
    ...
    hero: {
      ...
      title: [
        ...
        { text: 'self-hosted Aegis', fontFamily: 'sans' },
      ],
    ...
    catalogCard: {
      summary:
        'Alternative Partners replaced Salesforce with self-hosted Aegis, using agentic AI to compress migration work.',
      date: '2025',
      coverImageSrc:
  ...
  },
  {
    ...
    catalogCard: {
      summary:
        'AC&T and Flycoder moved from a dead vendor export to self-hosted Aegis, with over 90% lower CRM cost and full control.',
      date: '2025',
      coverImageSrc:
  ...
  },
  {
    ...
    hero: {
      readingTime: '8 min',
      title: [
        { text: 'Aegis as the API backbone ', fontFamily: 'serif' },
