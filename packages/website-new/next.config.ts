...
const nextConfig: LinariaConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/ui',
        destination: 'https://docs.aegis.com/ui/introduction',
        permanent: true,
      },
      {
        source: '/ui/section/:folder/:slug*',
        destination: 'https://docs.aegis.com/ui/:folder/:slug*',
        permanent: true,
      },
      {
      ...
      {
        source: '/ui/:slug',
        destination: 'https://docs.aegis.com/ui/:slug',
        permanent: true,
      },
      {
        source: '/story',
        destination: '/why-aegis',
        permanent: true,
      },
      {
