...
const buildCustomerParagraph = (
  ...
  text(
    ' object that ships with Aegis, so accounts, domain favicons, and the People relation work for free. ',
  ),
...
const WRAPUP_PARAGRAPH: StreamingSegment[] = [
  ...
  text(', and '),
  node('w-dev', <InlineCode>yarn aegis dev --once</InlineCode>),
  text('. Reference: '),
  node(
    'w-docs',
    <ReferenceLink
      href="https://aegis.com/developers"
      onClick={(event) => event.preventDefault()}
    >
      Aegis app-building docs
    </ReferenceLink>,
  ),
  text('.'),
];
