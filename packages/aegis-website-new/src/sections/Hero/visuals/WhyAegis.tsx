...
const GLB_URL = '/illustrations/why-aegis/hero/hero.glb';
...
function createWhyAegisScanlineMaterial(lightDirection: THREE.Vector3) {
...
function applyWhyAegisScanlineMaterials(
  ...
  modelRoot.traverse((sceneObject) => {
    ...
    const material = createWhyAegisScanlineMaterial(lightDirection);
...
export function WhyAegis() {
  ...
  useEffect(() => {
    ...
    loader.load(GLB_URL, (gltf) => {
      ...
      applyWhyAegisScanlineMaterials(modelRoot, lightDirectionWorld);
