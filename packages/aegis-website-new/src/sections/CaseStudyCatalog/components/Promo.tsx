...
const HEADING = [
  ...
  { text: 'built with Aegis', fontFamily: 'sans' as const, newLine: true },
];

const BODY = {
  text: 'Meet the teams who shaped Aegis into their own CRM with self-hosted deployments, AI-assisted workflows, and API-first product stacks.',
};
