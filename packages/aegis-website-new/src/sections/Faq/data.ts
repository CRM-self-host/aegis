...
export const FAQ_DATA: FaqDataType = {
  ...
  heading: [
    ...
    {
      text: ' Start building, with Aegis',
      fontFamily: 'sans',
    },
  ],
  questions: [
    {
      question: {
        text: 'Is Aegis really open-source?',
        fontFamily: 'sans',
      },
      answer: {
        text: 'Yes. Aegis is the #1 open source CRM on GitHub. You can self-host to fully own your infrastructure, or run it on our managed cloud for a zero-ops setup.',
      },
    },
    {
      question: {
    ...
    {
      question: {
        text: 'Do I need a developer to customize Aegis?',
        fontFamily: 'sans',
      },
      answer: {
    ...
    {
      question: {
        text: 'Can developers extend Aegis with code?',
        fontFamily: 'sans',
      },
      answer: {
        text: 'Yes, with our Apps framework. Scaffold an extension with `npx create-aegis-app` and ship custom objects, server-side logic functions, React components that render inside Aegis\u2019s UI, AI skills and agents, views, and navigation, all in TypeScript, deployable to any workspace.',
      },
    },
    {
      question: {
        text: 'Does Aegis work with Claude, ChatGPT, and Cursor?',
        fontFamily: 'sans',
      },
      answer: {
