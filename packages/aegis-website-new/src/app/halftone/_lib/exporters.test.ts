...
describe('halftone export naming', () => {
  ...
  it('sanitizes generated React component identifiers for the default Aegis export', () => {
...
describe('halftone react export presets', () => {
  it('emits a Aegis-ready GLB export with Draco support and no torus fallback', () => {
    const output = generateReactComponent(
      DEFAULT_HALFTONE_SETTINGS,
      IMPORTED_GLB_SHAPE,
      'PartnerConnect',
  ...
  it('emits a Aegis-ready image export without model loaders', () => {
  ...
  it('parses Aegis exports with header comments and named/default exports', () => {
    const output = generateReactComponent(
      DEFAULT_HALFTONE_SETTINGS,
      IMPORTED_GLB_SHAPE,
      'PartnerConnect',
