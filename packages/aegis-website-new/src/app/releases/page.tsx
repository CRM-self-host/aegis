...
export const metadata: Metadata = buildPageMetadata({
  path: '/releases',
  title: 'Releases | Aegis',
  description:
    'Discover the newest features and improvements in Aegis, the #1 open source CRM.',
});
    ...
    <>
      ...
      <Hero.Root backgroundColor={theme.colors.primary.background[100]}>
        ...
        <Hero.Cta>
          <LinkButton
            color="secondary"
            href="https://github.com/u84u/aegis/releases"
      ...
      <ReleaseNotes.Root>
        {allNotes.length === 0 ? (
          <ReleaseNotes.EmptyMessage>
            ...
            <strong>packages/aegis-website-new/src/content/releases</strong>{' '}
            and images under{' '}
            <strong>packages/aegis-website-new/public/images/releases</strong>.
          </ReleaseNotes.EmptyMessage>
