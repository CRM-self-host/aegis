  ...
  return (
    <>
      ...
      <ul>
        <li>
          <p>
            ...
            {
              ') and any related services or applications operated by Aegis.com PBC.'
            }
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            {
              ' – means a person or organization who (alone or jointly with others) determines the purposes and means of processing Personal Data. For the purposes of this Privacy Policy, Aegis is the Data Controller for Personal Data we collect directly from you.'
            }
          </p>
        </li>
        <li>
          <p>
            ...
            {
              ' – means a person or organization which processes Personal Data on behalf of the Data Controller. We may use the services of various third-party service providers to process your data more effectively. When you use Aegis’s cloud-based CRM, Aegis acts as a Data Processor for the Customer Data you input into our platform on behalf of your organization (see '
            }
      ...
      <p>
        ...
        {
          ' If you are using Aegis’s cloud-based CRM application, you may input or upload personal information about third parties (such as your customers, leads, or contacts) into our Service. This '
        }
        <strong>{'Customer Data'}</strong>
        {
          ' may include names, contact details, communications, transaction histories, and other information relevant to customer relationship management. In these cases, you (or your organization) act as the Data Controller for such Customer Data, and Aegis acts as a Data Processor on your behalf. We process this data solely to provide our CRM services to you and in accordance with your instructions. '
        }
        <strong>{'If you use Aegis in a self-hosted environment,'}</strong>
        {
      ...
      <p>
        {
          'Aegis uses the collected information for various purposes in order to operate our business, provide the Service to you, and improve our offerings. These purposes include:'
        }
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            {
              ' To provide you with news about Aegis, special offers, or general information about our products and services, but only where you have an existing relationship with us or have otherwise consented to receive such communications. You have the right to opt out of marketing messages at any time.'
            }
          </p>
        </li>
        <li>
      ...
      <p>
        {
          'As mentioned, Aegis uses cookies and similar tracking technologies to provide, secure, and improve our Service. This section explains those technologies in more detail and your choices regarding them.'
        }
      </p>
      ...
      <p>
        {
          'Depending on your jurisdiction and applicable data protection laws, you have certain rights regarding your Personal Data. Aegis is committed to facilitating the exercise of these rights for all users.'
        }
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            <strong>{'Aegis does not sell your personal information'}</strong>
            {
      ...
      <p>
        {
          'Additionally, California\'s "Shine the Light" law (Civil Code Section 1798.83) permits users of our Service who are California residents to request certain information regarding our disclosure of personal information to third parties for their direct marketing purposes. We do not disclose personal information to third parties for direct marketing without consent, so this provision is generally not applicable to Aegis’s practices.'
        }
      </p>
      ...
      <p>
        {
          'Our Service or website may contain links to other sites that are not operated by Aegis (for example, a link to an article, a partner’s website, or an integration provider). If you click on a third-party link, you will be directed to that third party’s site. We strongly advise you to review the privacy policy of every external site or service that you visit, as their privacy practices may differ from ours.'
        }
      </p>
      ...
      <ul>
        <li>
          <p>
            ...
            <a href={'mailto:privacy@aegis.com'}>{'privacy@aegis.com'}</a>
          </p>
        </li>
      </ul>
      ...
      <p>
        {
          'Thank you for trusting Aegis with your data. Your privacy is important to us, and we are committed to safeguarding it in accordance with this policy and applicable laws.'
        }
      </p>
    </>
  );
