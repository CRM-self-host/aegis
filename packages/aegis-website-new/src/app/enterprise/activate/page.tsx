...
export const metadata: Metadata = buildPageMetadata({
  ...
  title: 'Enterprise activation | Aegis',
  description:
    'Complete activation for your Aegis self-hosted enterprise license.',
});
...
const ENTERPRISE_ACTIVATE_BODY = {
  text: 'Your checkout is complete. Follow the steps below to copy your license key into your Aegis instance.',
};
