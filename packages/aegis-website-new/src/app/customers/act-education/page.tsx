...
const CASE_STUDY: CaseStudyData = {
  meta: {
    title:
      'Burned by vendor lock-in, AC&T built a CRM they actually own | Aegis',
    description:
      'How AC&T Education Migration and Flycoder replaced a shuttered vendor CRM with self-hosted Aegis, with 90%+ lower cost and full ownership.',
  },
  hero: {
    readingTime: '7 min',
    title: [
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Because everything is built on Aegis's open foundation, Flycoder could wire the exact logic AC&T needed without fighting the platform.",
      ],
    },
    {
      type: 'text',
