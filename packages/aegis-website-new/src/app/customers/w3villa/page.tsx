...
const CASE_STUDY: CaseStudyData = {
  meta: {
    title:
      'When your CRM is the product: W3Grads on Aegis | W3villa Technologies',
    description:
      'How W3villa Technologies shipped W3Grads, an AI mock interview platform for institutions, on Aegis as the operational backbone.',
  },
  hero: {
    readingTime: '8 min',
    title: [
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'W3villa built W3Grads (w3grads.com), an AI-powered mock interview platform for universities and training institutes, using Aegis as its operational backbone.',
        'The key decision was not to build everything from scratch. Aegis covers the data model, permissions, authentication, and workflow engine, the parts that would have taken months to rebuild, so the team could focus on product-specific logic.',
    ...
    },
    {
      ...
      callout:
        '"Aegis gave us the flexibility to model the entire interview lifecycle as custom objects and workflows. We could build something genuinely complex without fighting the platform to do it." - Piyush Khandelwal, Director, W3villa Technologies, Partner',
    },
    {
      type: 'text',
      eyebrow: 'The result',
      ...
      paragraphs: [
        ...
        'Zero manual work at the core. Full automation. Built on Aegis.',
      ],
    },
  ],
  tableOfContents: [
  ...
  catalogCard: {
    summary:
      'W3villa shipped W3Grads on Aegis for AI interviews, scoring, and institution-scale workflows without rebuilding CRM plumbing.',
    date: '2025',
  },
};
