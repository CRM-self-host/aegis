...
const CASE_STUDY: CaseStudyData = {
  meta: {
    title:
      'Aegis as the API backbone of a go-to-market stack | Elevate Consulting',
    description:
      'How Elevate Consulting moved off documents and spreadsheets to Aegis as the API-connected CRM at the center of their stack.',
  },
  hero: {
    readingTime: '8 min',
    title: [
      { text: 'Aegis as the ', fontFamily: 'serif' },
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        'In June 2025, Justin learned Aegis v1 had shipped. Within two or three days, the CEO asked him to look into setting up a CRM. The shift came from the potential of what could be built on top of fully open APIs. The timing was perfect.',
      ],
      callout:
        '"It is just such a nicer experience than dealing with a Salesforce or a HubSpot. My mission has been to get every tool API-accessible, so everything talks to each other. Aegis made that possible in a way older CRM platforms simply do not." - Justin Beadle, Director of Digital and Information, Elevate Consulting',
    },
    {
      type: 'text',
      eyebrow: 'Integration',
    ...
    },
    {
      ...
      paragraphs: [
        "Elevate's CEO was so impressed with Aegis he started recommending it to clients before the internal setup was even complete. The team is exploring bringing Aegis to client projects as part of their consulting practice, including as the backend for custom-built products tailored to specific operational needs.",
  ...
  catalogCard: {
    summary:
      'Elevate Consulting uses Aegis as the API backbone connecting billing, Teams, resourcing, and a custom front end around client and opportunity data.',
    date: 'Jun 2025',
  },
};
