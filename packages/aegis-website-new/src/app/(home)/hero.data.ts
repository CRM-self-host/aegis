...
export const HERO_DATA: HeroHomeDataType = {
  ...
  body: {
    text: 'Aegis gives technical teams the building blocks for a custom CRM that meets complex business needs and quickly adapts as the business evolves.',
  },
  visual: {
    ...
    workspaceNav: [
      ...
      },
      {
        ...
        icon: {
          kind: 'brand',
          brand: 'aegis',
          imageSrc: '/images/home/hero/aegis-demo-logo.webp',
          overlay: 'link',
        },
      },
    ],
