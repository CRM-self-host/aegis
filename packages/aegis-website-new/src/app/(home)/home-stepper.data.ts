...
export const HOME_STEPPER_DATA: HomeStepperDataType = {
  steps: [
    ...
    },
    {
      ...
      body: {
        text: "Don't get locked into someone else's ecosystem. Aegis's developer experience looks like normal software, with local setup, real data, live testing, and no proprietary tooling.",
      },
    },
  ],
};
