  ...
  illustrationCards: [
    {
      ...
      body: {
        text: 'W3villa used Aegis as a production-grade framework for the data model, permissions, authentication, and workflow engine they would otherwise have rebuilt themselves.',
      },
      benefits: undefined,
      attribution: {
    ...
    },
    {
      ...
      body: {
        text: 'AC&T moved to a self-hosted Aegis instance with no vendor risk, no forced migration, and CRM costs reduced by more than 90%.',
      },
      benefits: undefined,
      attribution: {
