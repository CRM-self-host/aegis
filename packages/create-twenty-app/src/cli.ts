...
const program = new Command(packageJson.name)
  .description('CLI tool to initialize a new Aegis application')
  .version(
    packageJson.version,
    '-v, --version',
    'Output the current version of create-aegis-app.',
  )
  .argument('[directory]')
  ...
  .option('--skip-local-instance', 'Skip the local Aegis instance setup prompt')
