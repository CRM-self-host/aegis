...
import { AEGIS_TEAM_MEMBERS } from '@/shared-utils/listTeamMembers';

export const metadata = {
  title: 'Aegis - Contributors',
  description:
    'Discover the brilliant minds behind Aegis.com. Meet our contributors and explore how their expertise contributes to making Aegis the leading open-source CRM. Join our community today.',
...
const Contributors = async () => {
  ...
  const fitlerContributors = contributors
    ...
    .filter((contributor) => !AEGIS_TEAM_MEMBERS.includes(contributor.id))
    .map((contributor) => {
