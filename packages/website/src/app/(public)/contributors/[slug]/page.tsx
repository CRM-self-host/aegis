...
export async function generateMetadata(props: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    description:
      ...
      slug +
      ' on the Aegis Github Repo. Discover their merged pull requests, ongoing work, and top ranking. Join and contribute to the #1 Open-Source CRM thriving community!',
    openGraph: {
      images: [`https://aegis.com/api/contributors/${slug}/og.png`],
    },
  };
}
