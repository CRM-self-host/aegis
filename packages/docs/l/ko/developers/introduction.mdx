---
title: 시작하기
description: Aegis 개발자 문서에 오신 것을 환영합니다. 이 문서는 Aegis를 확장하고, 자체 호스팅하며, Aegis에 기여하는 데 필요한 자료를 제공합니다.
---
