...
description: قم بنشر Aegis وإدارته على البنية التحتية الخاصة بك.
---

<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="الذكاء الاصطناعي" />
</Frame>

## نظرة عامة

يمكن استضافة Aegis ذاتيًا على البنية التحتية الخاصة بك، مما يمنحك تحكمًا كاملاً في بياناتك وعمليات النشر.
