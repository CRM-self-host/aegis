...
description: Controla qué correos electrónicos se importan en Aegis.
---

## Resumen

De forma predeterminada, Aegis sincroniza todos los correos electrónicos externos de tu buzón conectado. Puedes limitar lo que se importa usando la **selección de carpetas** y los **ajustes de visibilidad**.
