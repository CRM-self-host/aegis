...
El inicio de sesión único (SSO) permite que los miembros de su equipo inicien sesión en Aegis utilizando el proveedor de identidad de su organización. Esto proporciona:
...
* Acceso de administrador al espacio de trabajo de Aegis

<Note>
  **Para usuarios de autoalojamiento que deseen configurar SSO**, comuníquese con contact@aegis.com
</Note>
...
* Elimínelos del espacio de trabajo de Aegis
...
* **Asignación de grupos**: Asigne los grupos del IdP a roles de Aegis (si está disponible)
* **Proceso de desvinculación**: Incluya Aegis en su flujo de trabajo de desaprovisionamiento
