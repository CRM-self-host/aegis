...
description: Guía completa paso a paso para dar formato a tus datos para importarlos en Aegis.
---
...
**Este es el paso más importante.** El archivo de ejemplo te muestra los nombres de columna y el formato exactos que Aegis espera.
...
Aegis exige unicidad en determinados campos. Los duplicados provocarán errores de importación.
...
3. Comprueba si hay duplicados que ya existan en Aegis
...
* Debe ser único (sin duplicados en el archivo ni en Aegis)
...
* Debe ser único dentro de tu archivo y en Aegis
...
* **Enlaces / Etiqueta del enlace**: `Aegis`
* **Enlaces / URL del enlace**: `https://aegis.com`
...
* **Opcional**: Aegis genera IDs automáticamente si no se proporcionan
...
* El registro padre debe existir previamente en Aegis
...
## Paso 6: Asegúrate de que los campos existan en Aegis
