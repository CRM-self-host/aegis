---
title: Generar una cotización o una factura desde Aegis
...
* [Generar un PDF desde Aegis](/l/es/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — adjuntar los PDF generados a los registros
