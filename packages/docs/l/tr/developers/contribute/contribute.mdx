...
description: Aegis'nin açık kaynak geliştirmesine katkıda bulunun.
---
...
Aegis açık kaynaktır ve topluluktan gelen katkıları memnuniyetle karşılar. İster hataları düzeltiyor, ister özellikler ekliyor ya da belgeleri iyileştiriyor olun, katkılarınız Aegis'yi herkes için daha iyi hâle getirmeye yardımcı olur.
