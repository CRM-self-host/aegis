...
Dosyanızı yükledikten ve sütunları eşledikten sonra, Aegis verilerinizi doğrular:

1. **Doğrulama çalışır** — Aegis her satırı hatalar için kontrol eder
...
| ------------------------------------------------------------------------------ | -------------------------------------------------------------- |
| Yinelenen değerler sarı renkle vurgulanır                                      | Değer Aegis'de zaten mevcut veya dosyanızda iki kez görünüyor |
...
**Seçenek 3: Mevcut kaydı Aegis'nin güncellemesine izin verin**
...
3. Aegis, yinelenen bir kayıt oluşturmak yerine mevcut kaydı güncelleyecektir
...
Benzersiz tanımlayıcılardan biri eşleştiği sürece Aegis kaydı günceller.
</Note>
...
3. Kayıtların Aegis'de zaten mevcut olup olmadığını kontrol edin
...
Bu, Aegis'de o özel tanımlayıcıya sahip bir Şirket olmadığı anlamına gelir.
...
Aegis'de mevcut olmayan bir kayda bağlanmaya çalışıyorsunuz.
...
Dosyanızdaki bir sütun eşlenemiyor çünkü alan Aegis'de mevcut değil.
...
1. **Kullanıcı davetini kabul etmedi** — kullanıcı henüz Aegis'de mevcut değil
2. **Eski sistemdeki kullanıcı kimliğini kullanma** — Aegis başka bir sistemin kimliklerini eşleştiremez
3. **Yanlış e-posta biçimi** — e-posta, kullanıcının Aegis hesabıyla eşleşmiyor

### Nasıl Düzeltilir

1. Tüm kullanıcıların Aegis çalışma alanınıza **davetlerini kabul ettiğinden** emin olun
2. Kullanıcının **e-posta adresini** kullanın (adlarını veya eski sistem kimliğini değil)
3. Aegis'ye katılmak için kullandıkları aynı e-postayı kullanın
...
<Check>Alan adı biçimi, Aegis'nin biçimiyle birebir eşleşir</Check>
...
1. **Örnek dosyayı indirin** — Aegis'nin beklediği tam biçimi görün
