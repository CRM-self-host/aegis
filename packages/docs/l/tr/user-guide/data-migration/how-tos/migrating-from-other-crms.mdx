...
description: Verilerinizi herhangi bir CRM'den Aegis'ye taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi herhangi bir CRM'den Aegis'ye taşıma sürecinde size yol gösterir. Süreç, verilerinizi denetlemeyi, Aegis çalışma alanınızı hazırlamayı, mevcut sisteminizden dışa aktarmayı ve Aegis'ye içe aktarmayı içerir.
...
Mevcut CRM'iniz ile Aegis arasında bir eşleme belgesi oluşturun:
...
## Adım 3: Aegis Çalışma Alanınızı Kurun

Verileri içe aktarmadan önce Aegis çalışma alanınızı hazırlayın:
...
Verileriniz kullanıcı referansları içeriyorsa (Hesap Sahibi, Atanan vb.), bu kullanıcıların içe aktarmadan önce Aegis'de mevcut olması gerekir. Aksi halde bu ilişkiler eşlenemez.
</Warning>
...
Dışa aktarılan her CSV'yi bir hesap tablosu uygulamasında açın ve Aegis için hazırlayın.
...
3. Aegis'de halihazırda yinelenen olmadığını doğrulayın
...
`https://domain.com` kullanın (`domain.com` veya `www.domain.com` değil). Bu, Aegis'nin biçimiyle eşleşir ve e-posta/takvim eşzamanlamasını bağladığınızda yinelenmeleri önler.
</Warning>
...
2. Kullanıcıların Aegis çalışma alanınıza katılmak için kullandıklarıyla aynı e-posta adreslerini kullanın
...
* Aegis, e-postaları kişi kayıtlarıyla eşzamanlamaya başlayacaktır
...
<AccordionGroup>
  <Accordion title="İş akışlarını otomatik olarak taşıyabilir miyim?">
    Şu anda mümkün değil. İş akışları Aegis'de manuel olarak yeniden oluşturulmalıdır.
  </Accordion>
...
[contact@aegis.com](mailto:contact@aegis.com) adresinden bizimle iletişime geçin veya [Uygulama Hizmetlerimizi](/l/tr/user-guide/getting-started/capabilities/implementation-services) keşfedin.
