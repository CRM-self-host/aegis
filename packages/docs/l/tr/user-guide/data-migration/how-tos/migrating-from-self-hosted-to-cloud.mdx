...
description: Aegis kendi barındırmalı örneğinizi Aegis Cloud’a taşımak için adım adım kılavuz.
---

## Genel Bakış

Bu kılavuz, verilerinizi Aegis kendi barındırmalı örneğinizden Aegis Cloud’a taşıma sürecinde size adım adım yol gösterir. Süreç; bulut çalışma alanınızı kurmayı, verilerinizi dışa aktarmayı ve yeniden içe aktarmayı içerir.
...
1. [app.aegis.com](https://app.aegis.com) adresine gidin ve yeni bir çalışma alanı oluşturun
...
Karmaşık geçişler veya büyük veri kümeleri için [contact@aegis.com](mailto:contact@aegis.com) adresinden bize ulaşın veya [Uygulama Hizmetlerimizi](/l/tr/user-guide/getting-started/capabilities/implementation-services) inceleyin.
