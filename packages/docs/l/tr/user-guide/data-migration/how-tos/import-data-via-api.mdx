...
description: Büyük ölçekli veri içe aktarmaları için Aegis'nin API'lerini ne zaman ve nasıl kullanacağınız.
---

## Genel Bakış

Aegis, programatik veri içe aktarma için hem **GraphQL** hem de **REST API'leri** sunar. Veri hacminiz için CSV içe aktarma pratik değilse veya otomatik, yinelenen içe aktarmalara ihtiyacınız varsa API'yi kullanın.
...
Aegis, sistem kararlılığını sağlamak için hız sınırlarını uygular:
...
Aegis iki API türünü destekler:
...
* Biçimlerin Aegis'nin gereksinimlerine uyduğunu doğrulayın (bkz. [Alan Eşleme](/l/tr/user-guide/data-migration/capabilities/field-mapping))
...
* Verilerin Aegis'de doğru göründüğünü doğrulayın
