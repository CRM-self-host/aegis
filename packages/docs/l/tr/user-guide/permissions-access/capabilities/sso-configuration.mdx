...
Tek Oturum Açma (SSO), ekip üyelerinizin kuruluşunuzun kimlik sağlayıcısını kullanarak Aegis'ye giriş yapmasına olanak tanır. Bu şunları sağlar:
...
Aegis, SSO'yu şu sağlayıcılarla destekler:
...
* Aegis çalışma alanına yönetici erişimi

<Note>
**SSO'yu kurmak isteyen öz barındırma kullanıcıları için**, contact@aegis.com ile iletişime geçin
</Note>
...
* Aegis çalışma alanından kaldırın
...
* **Grup eşleme**: IdP gruplarını Aegis rollerine eşleyin (varsa)
* **Ayrılış süreci**: Erişim kaldırma iş akışınıza Aegis'yi dahil edin
