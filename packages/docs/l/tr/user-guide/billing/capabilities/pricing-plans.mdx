...
description: Aegis'nin fiyatlandırma planlarını ve bunlar arasında nasıl geçiş yapacağınızı öğrenin.
---

## Genel Bakış

İster bulut barındırma ister kendi kendine barındırmayı tercih edin, Aegis her ölçekte ekibe uyacak esnek fiyatlandırma sunar.
...
Aegis'yi kendi altyapınızda hiçbir ücret ödemeden barındırın:
