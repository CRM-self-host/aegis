...
description: Hangi e-postaların Aegis'ye içe aktarılacağını kontrol edin.
---

## Genel Bakış

Varsayılan olarak, Aegis bağlı posta kutunuzdan tüm harici e-postaları senkronize eder. **Klasör seçimi** ve **görünürlük ayarlarını** kullanarak içe aktarılanları sınırlayabilirsiniz.
