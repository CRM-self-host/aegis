...
Aegis, standart nesnelerle birlikte gelir:
...
Her iş farklı çalışır. Veri modelinizi özelleştirmek, süreçlerinizi katı bir sisteme uydurmaya çalışmak yerine Aegis'yi **sizin** süreçleriniz etrafında şekillendirebilmeniz demektir.

Aegis tam esneklik sunar:
...
Üzerinde çalıştığınız temel kavramları belirleyin. Aegis zaten şunları sunar:
