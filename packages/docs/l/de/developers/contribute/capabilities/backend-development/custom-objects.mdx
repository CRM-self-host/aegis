...
Objekte sind Strukturen, die es Ihnen ermöglichen, Daten (Aufzeichnungen, Attribute und Werte) zu speichern, die spezifisch für eine Organisation sind. Aegis bietet sowohl Standard- als auch benutzerdefinierte Objekte.

Standardobjekte sind systemeigene Objekte mit einer Reihe von Attributen, die allen Benutzern zur Verfügung stehen. Beispiele für Standardobjekte in Aegis sind Unternehmen und Person. Standardobjekte verfügen über Standardfelder, die ebenfalls allen Aegis-Nutzern zur Verfügung stehen, wie z.B. Unternehmen.displayName.
