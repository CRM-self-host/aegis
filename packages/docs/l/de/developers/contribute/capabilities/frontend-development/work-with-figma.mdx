...
info: Erfahren Sie, wie Sie im Figma von Aegis zusammenarbeiten können.
---
...
1. **Auf den freigegebenen Link zugreifen:** Sie können auf die Figma-Datei des Projekts [hier](https://www.figma.com/file/xt8O9mFeLl46C5InWwoMrN/Aegis) zugreifen.
...
In der linken Seitenleiste können Sie auf die verschiedenen Seiten der Figma-Datei von Aegis zugreifen. So sind sie organisiert:
