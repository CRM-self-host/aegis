...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer selbstgehosteten Aegis-Instanz zu Aegis Cloud.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von einer selbstgehosteten Aegis-Instanz zu Aegis Cloud. Der Prozess umfasst das Einrichten Ihres Cloud-Arbeitsbereichs, das Exportieren Ihrer Daten und deren erneutes Importieren.
...
1. Gehen Sie zu [app.aegis.com](https://app.aegis.com) und erstellen Sie einen neuen Arbeitsbereich
...
Bei komplexen Migrationen oder großen Datenmengen kontaktieren Sie uns unter [contact@aegis.com](mailto:contact@aegis.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
