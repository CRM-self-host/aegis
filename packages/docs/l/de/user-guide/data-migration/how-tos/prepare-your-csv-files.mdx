...
description: Vollständige Schritt-für-Schritt-Anleitung zum Formatieren deiner Daten für den Import in Aegis.
---
...
**Dies ist der wichtigste Schritt.** Die Beispieldatei zeigt dir die exakten Spaltennamen und das Format, das Aegis erwartet.
...
Aegis erzwingt die Eindeutigkeit bestimmter Felder. Duplikate führen zu Importfehlern.
...
3. Prüfe auf Duplikate, die in Aegis bereits existieren
...
* Muss eindeutig sein (keine Duplikate in der Datei oder in Aegis)
...
* Muss innerhalb deiner Datei und in Aegis eindeutig sein
...
* **Links / Link-Label**: `Aegis`
* **Links / Link-URL**: `https://aegis.com`

Für sekundäre Links verwenden Sie die Spalte **Links / Sekundäre Links**:

```
[{"url":"https://aegis.com","label":"Aegis"}]
```
...
* **Optional**: Aegis erstellt IDs automatisch, wenn sie nicht angegeben werden
...
* Der übergeordnete Datensatz muss bereits in Aegis vorhanden sein
...
## Schritt 6: Sicherstellen, dass Felder in Aegis vorhanden sind
