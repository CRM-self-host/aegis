...
Wenn Sie eine Datei hochladen, analysiert Aegis Ihre Spalten und versucht, sie bestehenden Feldern zuzuordnen.

### Automatische Zuordnung

Aegis versucht, Spalten anhand der folgenden Kriterien abzugleichen:

* Spaltenüberschriften (genaue oder ähnliche Übereinstimmungen)
* Erkennung des Datentyps (Datum, Zahlen, E-Mails)
* Häufige Feldmuster

<Note>**Schneller Tipp:** Exportieren Sie ein paar Zeilen aus dem Objekt, das Sie importieren möchten. Die exportierte Datei enthält genau die Spaltennamen, die Aegis erwartet, sodass die automatische Zuordnung beim Import reibungslos funktioniert.</Note>

### Optionen für die manuelle Zuordnung

Für jede Spalte können Sie:

* **Einem Feld zuordnen**: Wählen Sie das passende Aegis-Feld aus einem Dropdown aus
...
Die Angabe einer `id` während des Imports ist optional. Aegis erzeugt automatisch eine, wenn keine angegeben wird.
