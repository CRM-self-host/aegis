...
Single Sign-On (SSO) ermöglicht es Ihren Teammitgliedern, sich mit dem Identitätsanbieter Ihrer Organisation bei Aegis anzumelden. Dies bietet:
...
* Administratorzugriff auf den Aegis-Arbeitsbereich

<Note>
**Für Self-Hosting-Nutzer, die SSO einrichten möchten**, wenden Sie sich an contact@aegis.com
</Note>
...
* Entfernen Sie sie aus dem Aegis-Arbeitsbereich
...
* **Gruppenzuordnung**: Ordnen Sie IdP-Gruppen Aegis-Rollen zu (falls verfügbar)
* **Offboarding-Prozess**: Beziehen Sie Aegis in Ihren Deprovisioning-Workflow ein
