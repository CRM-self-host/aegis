...
description: Häufig gestellte Fragen zu Dashboards in Aegis.
---

<AccordionGroup>
  <Accordion title="Kann ich private Dashboards erstellen?">
    Nein, Dashboards sind derzeit für alle sichtbar, die Zugriff auf deinen Aegis-Arbeitsbereich haben. Private Dashboards sind noch nicht verfügbar.
  </Accordion>
  ...
  <Accordion title="Kann ich Dashboards mit externen Benutzerinnen und Benutzern teilen?">
    Nein, das Teilen von Dashboards mit Benutzerinnen und Benutzern außerhalb deines Aegis-Arbeitsbereichs (Nicht-Aegis-Benutzer) wird derzeit nicht unterstützt.
  </Accordion>
