---
title: Ein Angebot oder eine Rechnung aus Aegis erstellen.
...
* [Ein PDF aus Aegis generieren](/l/de/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — generierte PDFs an Datensätze anhängen
