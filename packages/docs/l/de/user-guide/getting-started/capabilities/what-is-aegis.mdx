---
title: Was ist Aegis
description: Aegis ist ein Open-Source-CRM, das Ihnen die Bausteine liefert, um genau das zu erstellen, was Ihr Unternehmen benötigt.
---
...
Zunächst sieht Aegis aus wie die meisten CRMs, die Sie bereits kennen: Sie können Geschäfte verfolgen, Kontakte organisieren, Aufgaben und Notizen verwalten.
...
Open-Source ist das Fundament unseres Ansatzes, das sicherstellt, dass Aegis sich mit seiner Gemeinschaft und für seine Gemeinschaft weiterentwickelt.
...
[Hier registrieren](https://app.aegis.com) oder [werden Sie ein Beitragender auf GitHub](https://github.com/u84u/aegis).
