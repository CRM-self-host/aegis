...
O menu de comandos oferece **acesso rápido a ações** no Aegis. Você pode acessá-lo de duas maneiras:
...
* Acessar registros excluídos (Aegis dá suporte a exclusões lógicas e permanentes)
