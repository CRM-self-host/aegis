...
description: Siga um guia passo a passo sobre como se registrar na Aegis, escolher um plano de assinatura e configurar sua conta.
---
...
1. Navegue até [Cadastro Aegis](https://app.aegis.com).
...
Para dúvidas ou ajuda, conecte-se com a equipe de suporte dedicada em [contact@aegis.com](mailto:contact@aegis.com) ou envie uma mensagem no [Discord](https://discord.gg/cx5n4Jzs57).
