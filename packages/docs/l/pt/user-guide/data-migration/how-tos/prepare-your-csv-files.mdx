...
description: Guia completo passo a passo para formatar seus dados para importação no Aegis.
---
...
**Esta é a etapa mais importante.** O arquivo de exemplo mostra os nomes exatos das colunas e o formato que o Aegis espera.
...
O Aegis impõe unicidade em determinados campos. Duplicados causarão erros de importação.
...
3. Verifique se há duplicados que já existem no Aegis
...
* Deve ser exclusivo (sem duplicados no arquivo ou no Aegis)
...
* Deve ser exclusivo dentro do seu arquivo e no Aegis
...
* **Links / Rótulo do Link**: `Aegis`
* **Links / URL do Link**: `https://aegis.com`
...
* **Opcional**: a Aegis gera IDs automaticamente se não forem fornecidos
...
* O registro pai já deve existir na Aegis
...
## Etapa 6: Garanta que os campos existam na Aegis
