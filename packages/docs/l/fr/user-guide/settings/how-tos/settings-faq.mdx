...
description: Foire aux questions sur les paramètres de Aegis.
---
...
<AccordionGroup>
  ...
  <Accordion title="Puis-je changer mon adresse e-mail ?">
    Pour changer votre adresse e-mail, veuillez contacter [contact@aegis.com](mailto:contact@aegis.com).
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Puis-je personnaliser le domaine de mon espace de travail ?">
    ...
    * **Sous-domaine** : Utilisez un sous-domaine Aegis comme `yourcompany.aegis.com`
