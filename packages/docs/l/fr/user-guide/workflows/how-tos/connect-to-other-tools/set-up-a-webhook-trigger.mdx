...
| **Intégrations personnalisées** | Votre application → automatisation dans Aegis                 |
...
3. Vous recevrez une URL de webhook unique, par exemple :
   ```
   https://api.aegis.com/webhooks/workflow/abc123...
   ```
...
```bash
curl -X POST https://api.aegis.com/webhooks/workflow/abc123... \
