...
Le menu de commandes vous donne **un accès rapide aux actions** dans Aegis. Vous pouvez y accéder de deux manières :
...
* Accéder aux enregistrements supprimés (Aegis prend en charge les suppressions logiques et définitives)
