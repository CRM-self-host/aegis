...
L'authentification unique (SSO) permet aux membres de votre équipe de se connecter à Aegis en utilisant le fournisseur d'identité de votre organisation. Cela offre :
...
Aegis prend en charge le SSO avec :
...
* Accès administrateur à l'espace de travail Aegis

<Note>
  **Pour les utilisateurs en auto-hébergement souhaitant configurer le SSO**, contactez contact@aegis.com
</Note>
...
* Retirez-les de l'espace de travail Aegis
...
* **Correspondance de groupes** : Faites correspondre les groupes IdP aux rôles Aegis (si disponible)
* **Processus de départ** : Incluez Aegis dans votre workflow de déprovisionnement
