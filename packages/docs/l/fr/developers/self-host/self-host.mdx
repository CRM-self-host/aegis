...
description: Déployez et gérez Aegis sur votre propre infrastructure.
---

<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="IA" />
</Frame>

## Vue d'ensemble

Aegis peut être auto-hébergé sur votre propre infrastructure, vous offrant un contrôle total sur vos données et votre déploiement.
