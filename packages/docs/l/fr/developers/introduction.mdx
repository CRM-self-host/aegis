---
title: Prise en main
description: Bienvenue dans la documentation pour développeurs de Aegis, vos ressources pour étendre, auto-héberger et contribuer à Aegis.
---
...
<CardGroup cols={2}>
  ...
  <Card href="/l/fr/developers/apps/apps" icon="puzzle-piece">
    ...
    Créez des applications personnalisées qui étendent les capacités de Aegis.
  </Card>

  <Card href="/l/fr/developers/self-host/self-host" icon="desktop">
    <CardTitle>Auto-héberger</CardTitle>
    Déployez et gérez Aegis sur votre propre infrastructure.
  </Card>

  <Card href="/l/fr/developers/contribute/contribute" icon="github">
    <CardTitle>Contribuer</CardTitle>
    Rejoignez notre communauté open source et contribuez à Aegis.
  </Card>
</CardGroup>
