...
Synchronisez facilement Aegis avec plus de 3000 applications à l'aide de [Zapier](https://zapier.com/). Automatisez les tâches, boostez la productivité et dynamisez vos relations client !
...
Depuis le dossier `packages/aegis-zapier`, exécutez :
