---
title: Genera un preventivo o una fattura da Aegis
...
* [Generare un PDF da Aegis](/l/it/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — allegare i PDF generati ai record
