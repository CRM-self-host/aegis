...
Aegis include oggetti standard:
...
Ogni azienda lavora in modo diverso. Personalizzare il tuo modello di dati significa poter modellare Aegis attorno ai **tuoi** processi invece di forzarli dentro un sistema rigido.

Aegis offre massima flessibilità:
...
Identifica i concetti principali con cui lavori. Aegis offre già:
