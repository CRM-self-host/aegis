...
description: Domande frequenti sulle impostazioni di Aegis.
---
...
Per modificare il tuo indirizzo email, contatta [contact@aegis.com](mailto:contact@aegis.com).
</Accordion>
...
* **Sottodominio**: usa un sottodominio di Aegis come `yourcompany.aegis.com`
