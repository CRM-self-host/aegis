...
description: Guida passo-passo per migrare la tua istanza Aegis self-hosted verso Aegis Cloud.
---

## Panoramica

Questa guida ti accompagna nella migrazione dei tuoi dati da un'istanza Aegis self-hosted a Aegis Cloud. Il processo prevede la configurazione dello spazio di lavoro cloud, l'esportazione dei dati e la loro reimportazione.
...
1. Vai su [app.aegis.com](https://app.aegis.com) e crea un nuovo spazio di lavoro
...
Per migrazioni complesse o set di dati di grandi dimensioni, contattaci all'indirizzo [contact@aegis.com](mailto:contact@aegis.com) oppure scopri i nostri [Servizi di Implementazione](/l/it/user-guide/getting-started/capabilities/implementation-services).
