...
Il Single Sign-On (SSO) consente ai membri del tuo team di accedere a Aegis utilizzando il provider di identità della tua organizzazione. Questo offre:
...
* Accesso amministratore allo spazio di lavoro Aegis

<Note>
**Per gli utenti self-hosting che desiderano configurare l'SSO**, contatta contact@aegis.com
</Note>
...
* Rimuovili dallo spazio di lavoro Aegis
...
* **Mappatura dei gruppi**: Mappa i gruppi IdP ai ruoli di Aegis (se disponibile)
* **Processo di offboarding**: Includi Aegis nel tuo flusso di lavoro di deprovisioning
