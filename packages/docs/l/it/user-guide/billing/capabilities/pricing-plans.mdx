...
description: Scopri i piani tariffari di Aegis e come passare da uno all'altro.
---

## Panoramica

Aegis offre prezzi flessibili per team di ogni dimensione, sia con hosting cloud sia con self‑hosting.
...
Esegui Aegis sulla tua infrastruttura senza costi:
