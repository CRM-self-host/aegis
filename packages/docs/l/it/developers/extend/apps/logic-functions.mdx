...
Il pacchetto `twenty-client-sdk` fornisce due client GraphQL tipizzati per interagire con l'API di Aegis dalle tue funzioni logiche e dai componenti front-end.
