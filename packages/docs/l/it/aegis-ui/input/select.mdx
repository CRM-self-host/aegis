...
<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="Intestazione" />
</Frame>
...
```jsx
import { IconAegisStar } from 'aegis-ui/display';
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Opzione A', Icon: IconAegisStar },
        { value: 'option2', label: 'Opzione B', Icon: IconAegisStar },
      ]}
      value="option1"
    />
  );
