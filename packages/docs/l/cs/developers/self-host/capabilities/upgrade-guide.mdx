...
1. Zastavte Aegis: `docker compose down`
2. Změňte hodnotu `TAG` v souboru `.env` vedle `docker-compose.yml`
3. Spusťte Aegis: `docker compose up -d`
...
Počínaje **v1.22** podporuje Aegis upgrade napříč verzemi. Můžete přejít přímo z jakékoli podporované verze na nejnovější vydání, aniž byste museli procházet každou meziverzí.
