...
Aegis obsahuje standardní objekty:
...
Každý podnik funguje jinak. Přizpůsobením datového modelu můžete přetvořit Aegis podle **svých** procesů namísto toho, abyste své procesy nutili do rigidního systému.

Aegis nabízí plnou flexibilitu:
...
Identifikujte hlavní pojmy, se kterými pracujete. Aegis již poskytuje:
