---
title: Orientace v prostředí Aegis
...
Nabídka příkazů vám v Aegis poskytuje **rychlý přístup k akcím**. K němu můžete přistoupit dvěma způsoby:
...
* Přistupujte k smazaným záznamům (Aegis podporuje logické i trvalé mazání)
