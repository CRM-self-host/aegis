---
title: Glosář
description: Seznamte se se základní terminologií používanou v aplikaci Aegis.
---

## API

API (rozhraní pro programování aplikací) umožňuje propojení Aegis s dalšími softwarovými systémy a vytváření vlastních integrací.
...
Příležitosti v Aegis CRM jsou potenciální obchody nebo prodeje s účty či kontakty.
...
Úkoly v Aegis CRM jsou přiřazené aktivity týkající se kontaktů, účtů nebo příležitostí.
...
Webhooky jsou automatizované zprávy odesílané z Aegis na jiné aplikace při výskytu specifických událostí, což umožňuje synchronizaci dat v reálném čase.
...
"Pracovní prostor" obvykle představuje společnost používající Aegis. Obsahuje všechny záznamy a data, která vy a členové vašeho týmu do Aegis přidáte.
...
Členové pracovního prostoru jsou uživatelé Aegis z vašeho týmu, kteří mají přístup k vašemu pracovnímu prostoru. Mohou být u záznamů přiřazeni jako vlastníci nebo přiřazené osoby.
