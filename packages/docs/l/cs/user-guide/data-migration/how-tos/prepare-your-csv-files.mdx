...
description: Kompletní návod krok za krokem, jak naformátovat data pro import do Aegis.
---
...
**Toto je nejdůležitější krok.** Ukázkový soubor ukazuje přesné názvy sloupců a formát, který Aegis očekává.
...
Aegis vynucuje jedinečnost u některých polí. Duplicity způsobí chyby při importu.
...
3. Zkontrolujte duplicity, které už v Aegis existují
...
* Musí být jedinečné (žádné duplicity v souboru ani v Aegis)
...
* Musí být jedinečné v rámci vašeho souboru i v Aegis
...
* **Odkazy / Štítek odkazu**: `Aegis`
* **Odkazy / URL odkazu**: `https://aegis.com`
...
* **Volitelné**: Aegis automaticky generuje ID, pokud nejsou zadána
...
* Nadřazený záznam musí v Aegis již existovat
...
## Krok 6: Ujistěte se, že pole v Aegis existují
