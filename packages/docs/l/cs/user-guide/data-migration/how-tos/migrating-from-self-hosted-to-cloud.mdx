...
description: Podrobný průvodce krok za krokem pro migraci vaší instance Aegis hostované na vlastním serveru do Aegis Cloud.
---

## Přehled

Tento průvodce vás provede migrací vašich dat z instance Aegis hostované na vlastním serveru do Aegis Cloud. Proces zahrnuje zřízení vašeho cloudového pracovního prostoru, export dat a jejich opětovný import.
...
1. Přejděte na [app.aegis.com](https://app.aegis.com) a vytvořte nový pracovní prostor
...
U složitých migrací nebo velkých datových sad nás kontaktujte na [contact@aegis.com](mailto:contact@aegis.com) nebo si prohlédněte naše [Implementační služby](/l/cs/user-guide/getting-started/capabilities/implementation-services).
