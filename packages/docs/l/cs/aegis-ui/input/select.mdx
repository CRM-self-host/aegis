...
<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="Hlavička" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Možnost A', Icon: IconAegisStar },
        { value: 'option2', label: 'Možnost B', Icon: IconAegisStar },
      ]}
      value="option1"
    />
  );
