...
description: Implementați și gestionați Aegis pe propria infrastructură.
---

<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="AI" />
</Frame>

## Prezentare generală

Aegis poate fi găzduit în regim propriu pe propria infrastructură, oferindu-vă control complet asupra datelor și a implementării.
