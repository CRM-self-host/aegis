...
description: Aflați despre planurile tarifare ale Aegis și cum să comutați între ele.
---

## Prezentare generală

Aegis oferă prețuri flexibile care se potrivesc echipelor de orice dimensiune, fie că preferați găzduirea în cloud sau autogăzduirea.
...
Găzduiți Aegis pe propria infrastructură, fără costuri:
...
* **Funcționalități premium**: integrare SSO și permisiuni la nivel de rând
* Asistență din partea echipei Aegis
