---
title: Generați o ofertă sau o factură din Aegis
...
* [Generați un PDF din Aegis](/l/ro/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — atașați PDF-uri generate la înregistrări
