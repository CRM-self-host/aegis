...
Aegis nu oferă încă suport nativ pentru câmpuri de formulă (va veni în 2026), dar poți obține același rezultat folosind fluxuri de lucru. Această soluție temporară îți permite să calculezi și să completezi automat valorile câmpurilor — de la concatenări simple la logică de business complexă.
