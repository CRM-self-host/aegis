...
description: Ghid pas cu pas pentru migrarea datelor din orice CRM către Aegis.
---

## Prezentare generală

Acest ghid vă ghidează prin procesul de migrare a datelor din orice CRM către Aegis. Procesul implică auditarea datelor, pregătirea spațiului de lucru Aegis, exportul din sistemul curent și importul în Aegis.
...
Creați un document de mapare între CRM-ul curent și Aegis:
...
## Pasul 3: Configurați spațiul dvs. de lucru Aegis

Înainte de a importa date, pregătiți spațiul dvs. de lucru Aegis:
...
Dacă datele dvs. includ referințe la utilizatori (Proprietar cont, Atribuit etc.), acei utilizatori trebuie să existe în Aegis înainte de import. În caz contrar, acele relații nu pot fi mapate.
</Warning>
...
Deschideți fiecare CSV exportat într-o aplicație de calcul tabelar și pregătiți-l pentru Aegis.
...
3. Verificați că nu există deja duplicate în Aegis
...
Folosiți `https://domain.com` (nu `domain.com` sau `www.domain.com`). Acest lucru corespunde formatului Aegis și previne duplicatele când conectați sincronizarea e-mailului/calendarului.
</Warning>
...
2. Folosiți aceleași adrese de e-mail pe care utilizatorii le-au folosit pentru a se alătura spațiului dvs. de lucru Aegis
...
* Aegis va începe să sincronizeze e-mailurile cu înregistrările de contact
...
<AccordionGroup>
  <Accordion title="Pot migra fluxurile de lucru automat?">
    Momentan, nu. Fluxurile de lucru trebuie recreate manual în Aegis.
  </Accordion>
...
Contactați [contact@aegis.com](mailto:contact@aegis.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
