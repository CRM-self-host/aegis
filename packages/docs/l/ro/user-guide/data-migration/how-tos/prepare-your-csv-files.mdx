...
description: Ghid complet, pas cu pas, pentru a formata datele pentru import în Aegis.
---
...
**Acesta este cel mai important pas.** Fișierul de mostră vă arată exact denumirile de coloane și formatul pe care îl așteaptă Aegis.
...
Aegis impune unicitatea pentru anumite câmpuri. Valorile duplicate vor provoca erori la import.
...
3. Verificați duplicatele care există deja în Aegis
...
* Trebuie să fie unic (fără duplicate în fișier sau în Aegis)
...
* Trebuie să fie unic în fișierul dvs. și în Aegis
...
* **Linkuri / Etichetă link**: `Aegis`
* **Linkuri / URL link**: `https://aegis.com`
...
* **Opțional**: Aegis generează automat ID-uri dacă nu sunt furnizate
...
* Înregistrarea părinte trebuie să existe deja în Aegis
...
## Pasul 6: Asigurați-vă că câmpurile există în Aegis
