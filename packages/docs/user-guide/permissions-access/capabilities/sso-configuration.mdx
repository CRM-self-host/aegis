...
Single Sign-On (SSO) allows your team members to log into Aegis using your organization's identity provider. This provides:
...
- Admin access to Aegis workspace

<Note>
**For self-hosting users willing to set up SSO**, reach out to contact@aegis.com
</Note>
...
- Remove them from the Aegis workspace
...
- **Group mapping**: Map IdP groups to Aegis roles (if available)
- **Offboarding process**: Include Aegis in your deprovisioning workflow
