...
description: Complete step-by-step guide to format your data for import into Aegis.
---
...
**This is the most important step.** The sample file shows you the exact column names and format Aegis expects.
...
Aegis enforces uniqueness on certain fields. Duplicates will cause import errors.
...
3. Check for duplicates that already exist in Aegis
...
- Must be unique (no duplicates in file or in Aegis)
...
- Must be unique within your file and in Aegis
...
### ID Fields
- **Optional**: Aegis auto-generates IDs if not provided
...
- The parent record must already exist in Aegis
...
## Step 6: Ensure Fields Exist in Aegis
