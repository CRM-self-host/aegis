...
description: Step-by-step guide to migrate your Aegis self-hosted instance to Aegis Cloud.
---

## Overview

This guide walks you through migrating your data from a Aegis self-hosted instance to Aegis Cloud. The process involves setting up your cloud workspace, exporting your data, and re-importing it.
...
1. Go to [app.aegis.com](https://app.aegis.com) and create a new workspace
...
For complex migrations or large datasets, contact us at [contact@aegis.com](mailto:contact@aegis.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
