...
description: When and how to use Aegis's APIs for large-scale data imports.
---

## Overview

Aegis provides both **GraphQL** and **REST APIs** for programmatic data import. Use the API when CSV import isn't practical for your data volume or when you need automated, recurring imports.
...
Aegis enforces rate limits to ensure system stability:
...
- Verify formats match Aegis's requirements (see [Field Mapping](/user-guide/data-migration/capabilities/field-mapping))
...
- Verify data appears correctly in Aegis
...
Contact us at [contact@aegis.com](mailto:contact@aegis.com) or explore our [Implementation Services](/user-guide/getting-started/capabilities/implementation-services).
