...
Aegis comes with standard objects:
...
Every business works differently. Customizing your data model means you can shape Aegis around **your** processes instead of forcing yours into a rigid system.

Aegis offers full flexibility:
...
Identify the main concepts you work with. Aegis already provides:
