---
title: Generate a Quote or Invoice from Aegis
...
- [Generate a PDF from Aegis](/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — attach generated PDFs to records
