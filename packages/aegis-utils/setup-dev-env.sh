#!/bin/bash
# =============================================================================
# Aegis CRM — Development Environment Setup
# =============================================================================
...
#   bash packages/aegis-utils/setup-dev-env.sh          # start + configure
#   bash packages/aegis-utils/setup-dev-env.sh --down    # stop services
#   bash packages/aegis-utils/setup-dev-env.sh --reset   # wipe data + restart
#   bash packages/aegis-utils/setup-dev-env.sh --docker  # force Docker mode
# =============================================================================
set -euo pipefail
