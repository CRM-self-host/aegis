---
title: Workflows
description: Automate your business processes with Aegis's visual workflow builder.
icon: "bolt"
---

import { VimeoEmbed } from '/snippets/vimeo-embed.mdx';

Workflows let you automate repetitive tasks and connect Aegis to external tools — without writing code (though you can if you want to).
...
- Sync data between Aegis and your billing system
