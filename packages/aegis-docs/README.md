...
Official documentation for Aegis CRM, powered by [Mintlify](https://mintlify.com).

## 🌐 Live Site

Visit the documentation at [docs.aegis.com](https://docs.aegis.com)

## 📚 Content

This repository contains:
- **User Guide** (46 pages) - Complete guide for Aegis users
- **Developers** (24 pages) - Technical documentation for developers
- **Aegis UI** (25 pages) - UI component library documentation
...
```bash
# From the aegis monorepo root
npx nx run aegis-docs:dev
```
...
1. Edit MDX files in the appropriate directory:
   ...
   - `aegis-ui/` - Component documentation
...
4. For each translated locale pulled from Crowdin, ensure a `packages/aegis-docs/l/<language>/navigation.json` file exists. These files contain **labels only**; page slugs always come from the base structure.
...
npx nx run aegis-docs:build
```

## 🔗 Links

- [Aegis Website](https://aegis.com)
- [GitHub Repository](https://github.com/u84u/aegis)
...
2. Make your changes in the `packages/aegis-docs` directory
3. Test locally with `npx nx run aegis-docs:dev`
4. Submit a pull request

## 📄 License

This documentation is part of the Aegis project and is licensed under [AGPL-3.0](../../LICENSE).
