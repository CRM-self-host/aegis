...
if [ -d "packages/aegis-docs" ]; then
  DOCS_DIR="packages/aegis-docs/l"
elif [ -d "l" ]; then
  DOCS_DIR="l"
else
...
for lang_dir in "$DOCS_DIR"/*/ ; do
  ...
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|href=\"/aegis-ui/|href=\"/l/$lang_code/aegis-ui/|g" {} \;
  ...
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|](/aegis-ui/|](/l/$lang_code/aegis-ui/|g" {} \;

  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.aegis\.com/user-guide/|https://docs.aegis.com/l/$lang_code/user-guide/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.aegis\.com/developers/|https://docs.aegis.com/l/$lang_code/developers/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.aegis\.com/aegis-ui/|https://docs.aegis.com/l/$lang_code/aegis-ui/|g" {} \;

  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.aegis\.com/user-guide/|https://docs.aegis.com/$lang_code/user-guide/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.aegis\.com/developers/|https://docs.aegis.com/$lang_code/developers/|g" {} \;
  find "$lang_dir" -name "*.mdx" -type f -exec sed -i.bak \
    "s|https://docs\.aegis\.com/aegis-ui/|https://docs.aegis.com/$lang_code/aegis-ui/|g" {} \;
