---
title: Nastavení FAQ
description: Často kladené otázky k nastavení Aegis.
---
...
Chcete-li změnit svou e-mailovou adresu, kontaktujte prosím [contact@aegis.com](mailto:contact@aegis.com).
</Accordion>
...
* **Poddoména**: Použijte poddoménu Aegis, například `yourcompany.aegis.com`
