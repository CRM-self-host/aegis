...
description: Sledujte podrobný návod, jak se zaregistrovat na Aegis, vybrat si plán předplatného a nastavit svůj účet.
---
...
1. Přejděte na [Registrace Aegis](https://app.aegis.com).
...
V případě dotazů nebo potřeby pomoci kontaktujte specializovaný tým podpory na [contact@aegis.com](mailto:contact@aegis.com) nebo pošlete zprávu na [Discord](https://discord.gg/cx5n4Jzs57).
