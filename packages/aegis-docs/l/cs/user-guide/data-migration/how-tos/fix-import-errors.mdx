...
Po nahrání souboru a namapování sloupců Aegis vaše data ověří:

1. **Proběhne validace** — Aegis zkontroluje každý řádek na chyby
...
| --------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Duplicitní hodnoty zvýrazněné žlutě                                   | Hodnota již existuje v Aegis nebo se ve vašem souboru vyskytuje dvakrát |
...
**Možnost 3: Nechte Aegis aktualizovat existující záznam**
...
3. Aegis aktualizuje existující záznam místo vytvoření duplicity
...
Pokud se shoduje alespoň jeden jedinečný identifikátor, Aegis záznam aktualizuje.
</Note>
...
3. Zkontrolujte, zda záznamy v Aegis již existují
...
To znamená, že v Aegis neexistuje společnost s tímto konkrétním identifikátorem.
...
Pokoušíte se propojit se záznamem, který v Aegis neexistuje.
...
Sloupec ve vašem souboru nelze namapovat, protože pole v Aegis neexistuje.
...
1. **Uživatel nepřijal pozvánku** — uživatel zatím v Aegis neexistuje
2. **Používáte uživatelské ID ze starého systému** — Aegis nedokáže spárovat ID z jiného systému
3. **Nesprávný formát e-mailu** — e-mail neodpovídá účtu uživatele v Aegis

### Jak to opravit

1. Ujistěte se, že všichni uživatelé **přijali svou pozvánku** do vašeho pracovního prostoru Aegis
2. Použijte **e-mailovou adresu** uživatele (ne jeho jméno nebo ID ze starého systému)
3. Použijte stejný e-mail, jaký použili k připojení do Aegis
...
<Check>Formát domény přesně odpovídá formátu Aegis</Check>
...
1. **Stáhněte si ukázkový soubor** — uvidíte přesný formát, který Aegis očekává
