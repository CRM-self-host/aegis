---
title: Fakturace
description: Seznamte se s cenami Aegis a spravujte své předplatné.
---

Aegis nabízí flexibilní cenové plány, které vyhoví potřebám vašeho týmu. Spravujte své předplatné, sledujte kredity pracovních postupů a přistupujte k fakturám — to vše v **Nastavení → Fakturace**.

## Co najdete v této sekci

<CardGroup cols={2}>
  <Card title="Cenové plány" icon="tags" href="/l/cs/user-guide/billing/capabilities/pricing-plans">
    Zjistěte více o cenových plánech Aegis a o tom, co je zahrnuto.
  </Card>
...
| **Organizace (vlastní hosting)** | Vše z Pro + funkce Premium (SSO, oprávnění na úrovni řádků), podpora týmu Aegis, není vyžadováno publikování vašeho vlastního kódu jako open-source před distribucí |
...
**Mohu používat Aegis zdarma?**
Ano! Hostujte Aegis sami a získejte všechny funkce Pro zdarma.
