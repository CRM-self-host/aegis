---
title: Vytvořte nabídku nebo fakturu z Aegis
...
* [Vygenerovat PDF z Aegis](/l/cs/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — připojte vygenerované soubory PDF k záznamům
