...
Jednotné přihlášení (SSO) umožňuje členům vašeho týmu přihlašovat se do Aegis pomocí poskytovatele identity vaší organizace. To přináší:
...
* Administrátorský přístup k pracovnímu prostoru Aegis

<Note>
**Pro uživatele vlastního hostování, kteří chtějí nastavit SSO**, obraťte se na contact@aegis.com
</Note>
...
* Odeberte je z pracovního prostoru Aegis
...
* **Mapování skupin**: Namapujte skupiny z IdP na role v Aegis (pokud je k dispozici)
* **Proces offboardingu**: Zahrňte Aegis do svého pracovního postupu deprovisioningu
