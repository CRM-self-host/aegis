...
description: Ghid pas cu pas pentru migrarea instanței Aegis auto-găzduite la Aegis Cloud.
---

## Prezentare generală

Acest ghid vă ghidează prin migrarea datelor dvs. dintr-o instanță Aegis auto-găzduită către Aegis Cloud. Procesul presupune configurarea spațiului dvs. de lucru în cloud, exportarea datelor și reimportarea acestora.
...
1. Accesați [app.aegis.com](https://app.aegis.com) și creați un nou spațiu de lucru
...
Pentru migrarea complexă sau seturi mari de date, contactați-ne la [contact@aegis.com](mailto:contact@aegis.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
