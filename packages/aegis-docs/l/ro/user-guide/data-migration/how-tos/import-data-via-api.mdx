...
description: Când și cum să utilizați API-urile Aegis pentru importuri de date la scară mare.
---

## Prezentare generală

Aegis oferă atât **GraphQL**, cât și **API-uri REST** pentru importul programatic de date. Utilizați API-ul când importul CSV nu este practic pentru volumul dvs. de date sau când aveți nevoie de importuri automate, recurente.
...
Aegis impune limitări de rată pentru a asigura stabilitatea sistemului:
...
Aegis acceptă două tipuri de API:
...
* Verificați că formatele corespund cerințelor Aegis (consultați [Maparea câmpurilor](/l/ro/user-guide/data-migration/capabilities/field-mapping))
...
* Verificați că datele apar corect în Aegis
...
Contactați-ne la [contact@aegis.com](mailto:contact@aegis.com) sau explorați [Serviciile noastre de implementare](/l/ro/user-guide/getting-started/capabilities/implementation-services).
