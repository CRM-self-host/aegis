...
Aegis include obiecte standard:
...
Fiecare afacere funcționează diferit. Personalizarea modelului tău de date înseamnă că poți modela Aegis în jurul proceselor **tale**, în loc să le forțezi într-un sistem rigid.

Aegis oferă flexibilitate totală:
...
Identifică principalele concepte cu care lucrezi. Aegis oferă deja:
