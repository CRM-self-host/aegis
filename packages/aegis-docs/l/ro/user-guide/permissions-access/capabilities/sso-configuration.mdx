...
Single Sign-On (SSO) le permite membrilor echipei dvs. să se autentifice în Aegis folosind furnizorul de identitate al organizației dvs. Acest lucru oferă:
...
* Acces de administrator la spațiul de lucru Aegis

<Note>
**Pentru utilizatorii care se auto-găzduiesc și doresc să configureze SSO**, contactați contact@aegis.com
</Note>
...
* Eliminați-i din spațiul de lucru Aegis
...
* **Maparea grupurilor**: Mapați grupurile IdP la rolurile Aegis (dacă este disponibilă)
* **Proces de offboarding**: Includeți Aegis în fluxul dvs. de deprovisionare
