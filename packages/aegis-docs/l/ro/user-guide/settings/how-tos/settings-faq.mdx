...
description: Întrebări frecvente despre setările Aegis.
---
...
Pentru a vă schimba adresa de e-mail, vă rugăm să ne contactați la [contact@aegis.com](mailto:contact@aegis.com).
</Accordion>
...
* **Subdomeniu**: Folosiți un subdomeniu Aegis, de exemplu `yourcompany.aegis.com`
