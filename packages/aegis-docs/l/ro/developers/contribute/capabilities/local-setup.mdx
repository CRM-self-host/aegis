...
description: Ghidul pentru contribuitori (sau dezvoltatori curioși) care doresc să ruleze Aegis local.
---
...
Înainte de a instala și utiliza Aegis, asigurați-vă că instalați următoarele pe computerul dvs.:
...
Aegis necesită un cache Redis pentru a oferi cea mai bună performanță.
...
## Pasul 8: Utilizați Aegis

**Front-end**

Frontend-ul Aegis va rula la [http://localhost:3001](http://localhost:3001).
Vă puteți loga folosind contul demo implicit: `tim@apple.dev` (parolă: `tim@apple.dev`)

**Back-end**

* Serverul Aegis va fi operativ la [http://localhost:3000](http://localhost:3000)
