...
* **Componente Aegis UI** — import din `twenty-sdk/ui` (Button, Tag, Status, Chip, Avatar și altele)
...
Pachetul `twenty-client-sdk` oferă doi clienți GraphQL tipați pentru a interacționa cu API-ul Aegis din funcțiile de logică și componentele Front.
