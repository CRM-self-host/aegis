...
description: Guida completa passo passo per formattare i tuoi dati per l'importazione in Aegis.
---
...
**Questo è il passaggio più importante.** Il file di esempio ti mostra i nomi delle colonne e il formato esatti che Aegis si aspetta.
...
Aegis impone l'unicità su alcuni campi. I duplicati causeranno errori di importazione.
...
3. Verifica la presenza di duplicati già esistenti in Aegis
...
* Deve essere univoco (nessun duplicato nel file o in Aegis)
...
* Deve essere univoco all'interno del tuo file e in Aegis
...
* **Link / Etichetta del link**: `Aegis`
* **Link / URL del link**: `https://aegis.com`
...
* **Opzionale**: Aegis genera automaticamente gli ID se non forniti
...
* Il record padre deve già esistere in Aegis
...
## Passaggio 6: Verifica che i campi esistano in Aegis
