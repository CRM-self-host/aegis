...
description: Schritt-für-Schritt-Anleitung zur Migration Ihrer Daten von jedem CRM zu Aegis.
---

## Übersicht

Diese Anleitung führt Sie durch die Migration Ihrer Daten von jedem CRM zu Aegis. Der Prozess umfasst die Überprüfung Ihrer Daten, die Vorbereitung Ihres Aegis-Arbeitsbereichs, den Export aus Ihrem aktuellen System und den Import in Aegis.
...
Erstellen Sie ein Zuordnungsdokument zwischen Ihrem aktuellen CRM und Aegis:
...
## Schritt 3: Richten Sie Ihren Aegis-Arbeitsbereich ein

Bereiten Sie Ihren Aegis-Arbeitsbereich vor, bevor Sie Daten importieren:
...
Wenn Ihre Daten Benutzerreferenzen enthalten (Account Owner, Assignee usw.), müssen diese Benutzer vor dem Import in Aegis existieren. Andernfalls können diese Beziehungen nicht zugeordnet werden.
</Warning>
...
Öffnen Sie jede exportierte CSV in einer Tabellenkalkulationsanwendung und bereiten Sie sie für Aegis vor.
...
3. Überprüfen Sie, dass in Aegis keine Duplikate vorhanden sind
...
Verwenden Sie `https://domain.com` (nicht `domain.com` oder `www.domain.com`). Dies entspricht dem Format von Aegis und verhindert Duplikate, wenn Sie die E-Mail-/Kalendersynchronisierung verbinden.
</Warning>
...
2. Verwenden Sie dieselben E-Mail-Adressen, mit denen die Benutzer Ihrem Aegis-Arbeitsbereich beigetreten sind
...
## Schritt 6: In Aegis importieren
...
1. Navigieren Sie zum Objekt in Aegis
...
* Aegis beginnt, E-Mails mit Kontaktdatensätzen zu synchronisieren
...
<AccordionGroup>
  <Accordion title="Kann ich Workflows automatisch migrieren?">
    Derzeit nicht. Workflows müssen in Aegis manuell neu erstellt werden.
  </Accordion>
...
Kontaktieren Sie [contact@aegis.com](mailto:contact@aegis.com) oder informieren Sie sich über unsere [Implementierungsservices](/l/de/user-guide/getting-started/capabilities/implementation-services).
