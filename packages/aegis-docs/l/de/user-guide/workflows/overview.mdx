---
title: Workflows
description: Erfahren Sie, wie Sie Automatisierungen in Aegis erstellen.
---
...
Workflows sind die In-App-Funktion von Aegis zum Erstellen dieser Automatisierungen. Sie bieten Ihnen die Bausteine, um genau das zu schaffen, was Ihr Unternehmen braucht, wann es das braucht.
...
2. **Daten in und aus Aegis bringen**: Verbinden Sie Aegis über API-Aufrufe und Webhooks mit Ihrer Datenbank und anderen Werkzeugen.
...
* **Formular**: Eingaben von Benutzern innerhalb der Aegis-Oberfläche zum Zeitpunkt der Ausführung abfragen
