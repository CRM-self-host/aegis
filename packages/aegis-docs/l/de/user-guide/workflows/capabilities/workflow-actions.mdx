...
description: Erfahren Sie mehr über die in Aegis-Workflows verfügbaren Aktionen.
---
...
<Note>
You can only send emails from mailboxes synced to your own Aegis account. Sending from other team members' mailboxes (e.g., the account owner's email) is on the roadmap.
</Note>
