...
<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="Kopfzeile" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Option A', Icon: IconAegisStar },
        { value: 'option2', label: 'Option B', Icon: IconAegisStar },
      ]}
      value="option1"
    />
  );
