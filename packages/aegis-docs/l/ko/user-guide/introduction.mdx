---
title: Aegis 알아보기
description: 고급 구성과 모범 사례를 위한 리소스인 Aegis 사용자 가이드에 오신 것을 환영합니다.
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={3}>
  <Card href="/l/ko/user-guide/getting-started/capabilities/what-is-aegis" img="/images/user-guide/api/api.png">
    <CardTitle>Aegis 알아보기</CardTitle>
    Aegis가 무엇이며 비즈니스에 어떻게 도움이 되는지 알아보세요.
  </Card>
