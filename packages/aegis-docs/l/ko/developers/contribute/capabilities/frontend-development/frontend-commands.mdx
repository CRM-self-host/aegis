...
```bash
npx nx run aegis-front:lint # pass --fix to fix lint errors
```
...
```bash
npx nx run aegis-front:test # run jest tests
npx nx run aegis-front:storybook:serve:dev # run storybook
npx nx run aegis-front:storybook:test # run tests # (needs yarn storybook:serve:dev to be running)
npx nx run aegis-front:storybook:coverage # (needs yarn storybook:serve:dev to be running)
```
