---
title: Aegis を知る
description: Aegis ユーザーガイドへようこそ。高度な設定やベストプラクティスのためのリソースです。
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={3}>
  <Card href="/l/ja/user-guide/getting-started/capabilities/what-is-aegis" img="/images/user-guide/api/api.png">
    <CardTitle>Aegis を知る</CardTitle>
    Aegis とは何か、ビジネスにどのように役立つかを学びましょう。
  </Card>
