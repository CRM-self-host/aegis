---
title: 始めに
description: Aegis 開発者ドキュメントへようこそ。Aegis の拡張、セルフホスティング、貢献のためのリソースです。
---
