---
title: Générer un devis ou une facture depuis Aegis
...
* [Générer un PDF à partir de Aegis](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — joindre les PDF générés aux enregistrements
