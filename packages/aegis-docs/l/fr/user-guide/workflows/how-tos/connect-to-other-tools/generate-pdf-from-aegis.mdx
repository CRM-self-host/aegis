---
title: Générer un PDF depuis Aegis
description: Créez un flux de travail pour générer et joindre un PDF (par exemple un devis) à un enregistrement.
---

Générez ou récupérez automatiquement un PDF et joignez-le à un enregistrement dans Aegis. Cette fonctionnalité est couramment utilisée pour créer des devis, des factures ou des rapports liés aux Entreprises, aux Opportunités ou à d'autres objets.
...
2. Téléversement du fichier dans Aegis
...
export const main = async (
  ...
  // Replace with your Aegis GraphQL endpoint
  // Cloud: https://api.aegis.com/graphql
  // Self-hosted: https://your-domain.com/graphql
  const graphqlEndpoint = 'https://api.aegis.com/graphql';
...
* [Générer un devis ou une facture depuis Aegis](/l/fr/user-guide/workflows/how-tos/connect-to-other-tools/generate-quote-or-invoice-from-aegis)
