...
Aegis inclut des objets standard :
...
Chaque entreprise fonctionne différemment. La personnalisation de votre modèle de données vous permet de façonner Aegis autour de **vos** processus au lieu de forcer les vôtres dans un système rigide.

Aegis offre une flexibilité totale :
...
Identifiez les principaux concepts avec lesquels vous travaillez. Aegis propose déjà :
