...
description: Formats de fichiers pris en charge pour l’importation de données dans Aegis.
---

## Formats pris en charge

Aegis prend en charge trois formats de fichiers pour l’importation :
