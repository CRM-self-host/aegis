---
title: إنشاء عرض سعر أو فاتورة من Aegis
...
* [Generate a PDF from Aegis](/l/ar/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — attach generated PDFs to records
