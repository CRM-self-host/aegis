...
icon: laptop-code
description: الدليل للمساهمين (أو المطورين الفضوليين) الذين يرغبون في تشغيل Aegis محلياً.
---
...
قبل أن تتمكن من تثبيت واستخدام Aegis، تأكد من تثبيت الأمور التالية على جهاز الكمبيوتر الخاص بك:
...
يتطلب Aegis مخزن بيانات Redis لتقديم أفضل أداء.
...
## الخطوة الثامنة: استخدم Aegis

**الواجهة الأمامية**

ستكون واجهة Aegis الأمامية تعمل على  [http://localhost:3001](http://localhost:3001).
يمكنك تسجيل الدخول باستخدام حساب العرض التوضيحي الافتراضي: `tim@apple.dev` (كلمة المرور: `tim@apple.dev`)

**الخلفية**

* سيكون خادم Aegis متصلاً ويعمل على [http://localhost:3000](http://localhost:3000)
