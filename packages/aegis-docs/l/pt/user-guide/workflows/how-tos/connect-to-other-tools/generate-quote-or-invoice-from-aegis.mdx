---
title: Gerar um orçamento ou fatura no Aegis
...
* [Gerar um PDF a partir do Aegis](/l/pt/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — anexar PDFs gerados aos registros
