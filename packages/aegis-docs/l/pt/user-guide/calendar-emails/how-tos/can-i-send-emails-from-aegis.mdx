---
title: Posso enviar e-mails a partir do Aegis?
description: Informações sobre o envio de e-mails diretamente a partir do Aegis.
---

## Estado atual

A integração de e-mail do Aegis foi concebida para **sincronizar e apresentar** o seu histórico de e-mails. Não é possível redigir ou enviar e-mails diretamente a partir da interface do Aegis.
...
Embora não seja possível enviar e-mails manualmente a partir do Aegis, **pode enviar e-mails automaticamente utilizando Fluxos de Trabalho**. Isto é útil para:
...
Para sequências de e-mails e boletins informativos, recomendamos utilizar Fluxos de Trabalho para ligar o Aegis a uma ferramenta dedicada de marketing por e-mail.
...
A redação nativa de e-mails dentro do Aegis está no nosso roteiro. Junte-se às nossas [discussões no GitHub](https://github.com/u84u/aegis/discussions) para partilhar o seu caso de uso e ajudar a priorizar esta funcionalidade.
