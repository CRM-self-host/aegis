...
description: Perguntas frequentes sobre as configurações do Aegis.
---
...
Para alterar seu endereço de e-mail, entre em contato pelo [contact@aegis.com](mailto:contact@aegis.com).
</Accordion>
...
* **Subdomínio**: Use um subdomínio do Aegis como `yourcompany.aegis.com`
