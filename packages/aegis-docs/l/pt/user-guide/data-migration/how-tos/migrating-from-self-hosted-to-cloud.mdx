...
description: Guia passo a passo para migrar a sua instância Aegis auto-hospedada para a Aegis Cloud.
---

## Visão Geral

Este guia orienta-o na migração dos seus dados de uma instância Aegis auto-hospedada para a Aegis Cloud. O processo envolve configurar o seu espaço de trabalho na cloud, exportar os seus dados e voltar a importá-los.
...
1. Aceda a [app.aegis.com](https://app.aegis.com) e crie um novo espaço de trabalho
...
Para migrações complexas ou conjuntos de dados grandes, contacte-nos em [contact@aegis.com](mailto:contact@aegis.com) ou explore os nossos [Serviços de Implementação](/l/pt/user-guide/getting-started/capabilities/implementation-services).
