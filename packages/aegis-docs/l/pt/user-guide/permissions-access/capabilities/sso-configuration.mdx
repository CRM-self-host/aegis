...
O Single Sign-On (SSO) permite que os membros da sua equipe façam login no Aegis usando o provedor de identidade da sua organização. Isso oferece:
...
O Aegis oferece suporte a SSO com:
...
* Acesso de administrador ao workspace do Aegis

<Note>
**Para usuários de auto-hospedagem que desejam configurar SSO**, entre em contato pelo contact@aegis.com
</Note>
...
* Remova-os do workspace do Aegis
...
* **Mapeamento de grupos**: Mapeie os grupos do IdP para as funções do Aegis (se disponível)
* **Processo de desligamento**: Inclua o Aegis no seu fluxo de trabalho de desprovisionamento
