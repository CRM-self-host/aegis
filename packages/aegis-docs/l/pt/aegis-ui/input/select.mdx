...
<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="Cabeçalho" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Opção A', Icon: IconAegisStar },
        { value: 'option2', label: 'Opção B', Icon: IconAegisStar },
      ]}
      value="option1"
    />
  );
