...
O pacote `twenty-client-sdk` fornece dois clientes GraphQL tipados para interagir com a API do Aegis a partir das suas funções de lógica e componentes de front-end.
