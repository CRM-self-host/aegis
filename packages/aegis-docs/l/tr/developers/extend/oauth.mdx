...
| UI uzantılarına sahip Aegis Uygulaması             | [Uygulamalar](/l/tr/developers/extend/apps/getting-started) (OAuth otomatik olarak yönetilir) |

## Bir İstemci Kaydedin

Aegis, [RFC 7591](https://datatracker.ietf.org/doc/html/rfc7591) uyarınca **dinamik istemci kaydını** destekler. Manuel kurulum gerekmez — programatik olarak kaydedin:
...
Uygulamanız bir Aegis kullanıcısı adına hareket ettiğinde bu akışı kullanın.
...
Yetkilendirmeden sonra, Aegis `redirect_uri` adresinize geri yönlendirir:
...
Aegis, OAuth yapılandırmasını standart bir keşif uç noktasında yayımlar:
