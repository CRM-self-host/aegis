...
`twenty-client-sdk` paketi, mantık fonksiyonlarınızdan ve ön uç bileşenlerinizden Aegis API ile etkileşim kurmak için tip tanımlı iki GraphQL istemcisi sağlar.
