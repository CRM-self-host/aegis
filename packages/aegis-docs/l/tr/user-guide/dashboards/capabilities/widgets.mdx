---
title: Widget'lar
description: Aegis'deki widget türlerini ve görselleştirme seçeneklerini keşfedin.
---
...
Aegis, Müşteri İlişkileri Yönetimi (CRM) verilerinizi görselleştirmek için çeşitli widget türleri sunar.
