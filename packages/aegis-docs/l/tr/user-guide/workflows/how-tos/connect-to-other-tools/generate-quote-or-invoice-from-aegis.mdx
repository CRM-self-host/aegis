---
title: Aegis'den Teklif veya Fatura Oluşturun
...
* [Aegis'den bir PDF oluşturun](/l/tr/user-guide/workflows/how-tos/connect-to-other-tools/generate-pdf-from-aegis) — oluşturulan PDF'leri kayıtlara ekleyin
