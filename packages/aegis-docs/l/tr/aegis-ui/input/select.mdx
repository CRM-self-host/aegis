...
<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="Başlık" />
</Frame>
...
export const MyComponent = () => {
  ...
  return (
    <Select
      ...
      options={[
        { value: 'option1', label: 'Seçenek A', Icon: IconAegisStar },
        { value: 'option2', label: 'Seçenek B', Icon: IconAegisStar },
      ]}
      value="option1"
    />
  );
