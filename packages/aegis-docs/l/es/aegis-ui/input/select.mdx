...
<Frame>
  <img src="/images/user-guide/what-is-aegis/20.png" alt="Encabezado" />
</Frame>
    ...
    export const MyComponent = () => {
      ...
      return (
          <Select
            ...
            options={[
              { value: 'option1', label: 'Opción A', Icon: IconAegisStar },
              { value: 'option2', label: 'Opción B', Icon: IconAegisStar },
            ]}
            value="option1"
          />
      );
