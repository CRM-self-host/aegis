---
title: Descubre Aegis
description: Bienvenido a la Guía del usuario de Aegis, tu recurso para configuraciones avanzadas y mejores prácticas.
---

import { CardTitle } from "/snippets/card-title.mdx"

<CardGroup cols={3}>
  <Card href="/l/es/user-guide/getting-started/capabilities/what-is-aegis" img="/images/user-guide/api/api.png">
    <CardTitle>Descubre Aegis</CardTitle>
    Aprende qué es Aegis y cómo puede ayudar a tu empresa.
  </Card>
  ...
  <Card href="/l/es/user-guide/permissions-access/overview" img="/images/user-guide/halftone/permissions.png">
    ...
    Gestiona los roles y el acceso a Aegis.
  </Card>

  <Card href="/l/es/user-guide/billing/overview" img="/images/user-guide/halftone/billing.png">
    <CardTitle>Facturación</CardTitle>
    Comprende cómo funcionan los precios y la facturación de Aegis.
  </Card>
