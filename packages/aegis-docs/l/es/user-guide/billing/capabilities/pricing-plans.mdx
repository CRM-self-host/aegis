...
description: Obtén información sobre los planes de precios de Aegis y cómo cambiar entre ellos.
---

## Resumen

Aegis ofrece precios flexibles para adaptarse a equipos de todos los tamaños, tanto si prefieres alojamiento en la nube como autoalojamiento.
...
Aloja Aegis en tu propia infraestructura sin costo:
