...
description: Siga una guía paso a paso sobre cómo registrarse en Aegis, elegir un plan de suscripción y configurar su cuenta.
---
...
1. Dirígete a [Aegis Sign Up](https://app.aegis.com).
...
Para consultas o ayuda, contacta con el equipo de soporte dedicado en [contact@aegis.com](mailto:contact@aegis.com) o envía un mensaje por [Discord](https://discord.gg/cx5n4Jzs57).
