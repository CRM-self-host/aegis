...
description: Enable Early Access features in Aegis.
---
...
<Note>
Early Access features may change based on user feedback. Your input helps us improve Aegis!
</Note>

## Feature Feedback

Your feedback helps improve Aegis:
