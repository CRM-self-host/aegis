---
title: Can I Send Emails from Aegis?
description: Information about sending emails directly from Aegis.
---

## Current Status

Aegis's email integration is designed to **sync and display** your email history. Emails cannot be composed or sent directly from Aegis's interface.
...
While you can't send emails manually from Aegis, you **can send emails automatically using Workflows**. This is useful for:
...
For email sequences and newsletters, we recommend using workflows to connect Aegis to a dedicated email marketing tool.
...
Native email composition from within Aegis is on our roadmap. Join our [GitHub discussions](https://github.com/u84u/aegis/discussions) to share your use case and help prioritize this feature.
