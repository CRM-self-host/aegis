...
description: Control which emails are imported into Aegis.
---

## Overview

By default, Aegis syncs all external emails from your connected mailbox. You can limit what gets imported using **folder selection** and **visibility settings**.
