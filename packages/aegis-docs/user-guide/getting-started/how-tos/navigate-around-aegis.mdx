...
The command menu gives you **quick access to actions** in Aegis. You can access it in two ways:
...
- Create new views
- Access deleted records (Aegis supports soft and hard deletes)
