---
title: Pricing Plans
description: Learn about Aegis's pricing plans and how to switch between them.
---

## Overview

Aegis offers flexible pricing to fit teams of all sizes, whether you prefer cloud hosting or self-hosting.
...
### Free (Self-Hosted)
Host Aegis on your own infrastructure at no cost:
