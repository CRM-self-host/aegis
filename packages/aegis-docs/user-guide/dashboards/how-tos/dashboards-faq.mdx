...
description: Frequently asked questions about dashboards in Aegis.
---

<AccordionGroup>
  <Accordion title="Can I create private dashboards?">
    No, dashboards are currently visible to everyone with access to your Aegis workspace. Private dashboards are not yet available.
  </Accordion>
  ...
  <Accordion title="Can I share dashboards with external users?">
    No, sharing dashboards with users outside your Aegis workspace (non-Aegis users) is not currently supported.
  </Accordion>
