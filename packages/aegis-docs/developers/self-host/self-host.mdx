---
title: Self-Host
description: Deploy and manage Aegis on your own infrastructure.
---
<Frame>
...
Aegis can be self-hosted on your own infrastructure, giving you full control over your data and deployment.
