...
### Documentation Files
- **69 MDX files** copied from aegis-website to aegis-docs
...
3. Set subdirectory to `packages/aegis-docs`
...
6. **Deprecate aegis-website docs** - Once migration is confirmed working
