...
import {
  ...
  CurrencyCode,
} from 'shared/branding-constants';
...
//TODO : isIncludedInUniqueConstraint refactor - https://github.com/u84u/core-team-issues/issues/1097
...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@aegis.com',
        additionalEmails: [
          'tim@aegis.com',
          'timapple@aegis.com',
          'johnappletim@aegis.com',
        ],
      },
      {
        primaryEmail: 'jane@aegis.com',
        additionalEmails: ['jane@aegis.com', 'jane.doe@aegis.com'],
      },
      {
        primaryEmail: 'john@aegis.com',
        additionalEmails: ['john.doe@aegis.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'aegis.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'aegis.com', label: 'Aegis' }],
      },
      {
        primaryLinkUrl: 'github.com/u84u/aegis',
        primaryLinkLabel: 'Aegis Repo',
        secondaryLinks: [{ url: 'aegis.com', label: '' }],
      },
      {
