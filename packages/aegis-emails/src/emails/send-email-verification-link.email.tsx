...
import { type APP_LOCALES } from 'aegis-shared/translations';
...
export const SendEmailVerificationLinkEmail = ({
  ...
  const bodyId = isEmailUpdate
    ? 'We received a request to change the email address associated with your Aegis account. Click below to confirm this change.'
    : 'Thanks for registering for an account on Aegis! Before we get started, we just need to confirm that this is you. Click below to verify your email address.';
...
SendEmailVerificationLinkEmail.PreviewProps = {
  link: 'https://app.aegis.com/verify-email/123',
  locale: 'en',
  isEmailUpdate: false,
};
