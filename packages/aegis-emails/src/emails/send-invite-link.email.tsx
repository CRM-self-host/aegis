...
import { WhatIsAegis } from 'src/components/WhatIsAegis';
import { capitalize } from 'src/utils/capitalize';
import { createI18nInstance } from 'src/utils/i18n.utils';
import { type APP_LOCALES } from 'aegis-shared/translations';
import { getImageAbsoluteURI } from 'aegis-shared/utils';
...
export const SendInviteLinkEmail = ({
  ...
  return (
    <BaseEmail width={333} locale={locale}>
      <Title value={i18n._('Join your team on Aegis')} />
      <MainText>
        <Trans
