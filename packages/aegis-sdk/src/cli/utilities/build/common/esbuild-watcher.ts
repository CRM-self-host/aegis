...
import { createStubAegisSdkDefinePlugin } from '@/cli/utilities/build/common/plugins/stub-aegis-sdk-define.plugin';
import {
...
import { NODE_ESM_CJS_BANNER, OUTPUT_DIR } from 'aegis-shared/application';
  ...
  new EsbuildWatcher({
    ...
    config: {
      ...
      extraPlugins: [
        ...
        createStubAegisSdkDefinePlugin(),
      ],
