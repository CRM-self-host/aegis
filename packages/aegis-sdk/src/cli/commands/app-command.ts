...
import { SyncableEntity } from 'aegis-shared/application';
...
export const registerCommands = (program: Command): void => {
  ...
  program
    ...
    .description('Build, sync, and generate API client into .aegis/output/')
  ...
  program
    ...
    .description('Build and upload application to a Aegis server')
  ...
  program
    ...
    .description('Uninstall application from Aegis')
