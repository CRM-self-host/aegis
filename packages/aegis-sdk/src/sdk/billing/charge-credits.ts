...
// Records credit usage against the running application via the Aegis
// server's `/app/billing/charge` endpoint. Reads `AEGIS_API_URL` and
// `AEGIS_APP_ACCESS_TOKEN` from the execution env (injected by the
