...
// stay in `aegis-sdk/define` — they are build-time metadata factories that
// the SDK CLI stubs out before bundling. Logic-function source files keep
// importing them from `aegis-sdk/define`, but should reach for *types* (and
// future runtime helpers) here, never directly from `aegis-shared/*`.
...
export type { InputJsonSchema } from 'aegis-shared/logic-function';
