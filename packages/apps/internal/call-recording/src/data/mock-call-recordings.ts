  ...
  },
  {
    ...
    transcript: {
      ...
      markdown: [
        ...
        '**Tom Wilson:** We can absolutely structure it that way. In fact, phased rollouts often lead to better adoption. We could do phase one for thirty thousand and phase two for aegis-five, with phase two starting three months later.',
  ...
  },
  {
    ...
    transcript: {
      ...
      markdown: [
        ...
        '**Marcus Lee:** Great, the team is excited to get started. We have aegis users ready to go on day one.',
  ...
  },
  {
    ...
    transcript: {
      ...
      markdown: [
        ...
        '**Jennifer Brooks:** This would save me so much time. What does pricing look like for a team of aegis-five?',
      ].join('\n\n'),
    },
    summary: {
      blocknote: null,
  ...
  },
  {
    ...
    transcript: {
      ...
      markdown: [
        ...
        '**Alex Nguyen:** Really well. Our sales cycle has shortened by about aegis percent. Reps are closing deals faster because they have all the context in one place.',
  ...
  },
  {
    ...
    transcript: {
      ...
      markdown: [
        ...
        '**Maria Santos:** I\'ll put together a total cost of ownership analysis that includes licensing, implementation, training, and ongoing support. We\'re typically fifteen to aegis percent lower than our main competitors when you factor in everything.',
  ...
  },
  {
    ...
    transcript: {
      ...
      markdown: [
        ...
        '**Nathan Kim:** Meridian Corp at three hundred and aegis K — contract is out for signature. TechFlow at two hundred and ten K — verbal agreement, just working through procurement. And BrightPath at one hundred and fifty K — they want to start before their fiscal year end on October fifteenth.',
