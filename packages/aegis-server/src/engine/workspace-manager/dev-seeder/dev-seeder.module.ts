...
import { AegisStandardApplicationModule } from 'src/engine/workspace-manager/aegis-standard-application/aegis-standard-application.module';
...
@Module({
  imports: [
    ...
    AegisStandardApplicationModule,
    SdkClientModule,
    UpgradeModule,
  ],
