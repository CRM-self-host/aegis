...
import { type ViewFilterOperand } from 'aegis-shared/types';
...
import { type AllStandardObjectViewFilterName } from 'src/engine/workspace-manager/aegis-standard-application/types/all-standard-object-view-filter-name.type';
