import { type ObjectsPermissionsByRoleId } from 'aegis-shared/types';
...
import { WorkspaceEntityManager } from 'src/engine/aegis-orm/entity-manager/workspace-entity-manager';
import { type WorkspaceQueryRunner } from 'src/engine/aegis-orm/query-runner/workspace-query-runner';
import { type WorkspaceRepository } from 'src/engine/aegis-orm/repository/workspace.repository';
