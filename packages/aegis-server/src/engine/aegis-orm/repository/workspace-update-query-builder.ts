...
import { type RelationDisconnectQueryFieldsByEntityIndex } from 'src/engine/aegis-orm/entity-manager/types/relation-nested-query-fields-by-entity-index.type';
...
import { type WorkspaceDeleteQueryBuilder } from 'src/engine/aegis-orm/repository/workspace-delete-query-builder';
...
import { validateRLSPredicatesForRecords } from 'src/engine/aegis-orm/utils/validate-rls-predicates-for-records.util';
    ...
    try {
      ...
      if (before.length > QUERY_MAX_RECORDS) {
        throw new AegisORMException(
          ...
          AegisORMExceptionCode.TOO_MANY_RECORDS_TO_UPDATE,
          {
