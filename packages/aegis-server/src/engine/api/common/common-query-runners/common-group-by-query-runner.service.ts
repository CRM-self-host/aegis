...
import { formatColumnNameForRelationField } from 'src/engine/aegis-orm/utils/format-column-name-for-relation-field.util';
  ...
  private async addFiltersFromView({
    ...
    const recordFilterGroups = viewFilterGroups.map((viewFilterGroup) => {
      return {
        ...
        logicalOperator:
          viewFilterGroup.logicalOperator as unknown as RecordFilterGroupLogicalOperator, // TODO - https://github.com/u84u/aegis/issues/14746
