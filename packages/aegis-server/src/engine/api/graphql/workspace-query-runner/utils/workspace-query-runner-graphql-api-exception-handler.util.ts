...
import { AegisORMException } from 'src/engine/aegis-orm/exceptions/aegis-orm.exception';
import { aegisORMGraphqlApiExceptionHandler } from 'src/engine/aegis-orm/utils/aegis-orm-graphql-api-exception-handler.util';
...
export const workspaceQueryRunnerGraphqlApiExceptionHandler = (
  ...
  switch (true) {
    ...
    case error instanceof AegisORMException:
      return aegisORMGraphqlApiExceptionHandler(error);
