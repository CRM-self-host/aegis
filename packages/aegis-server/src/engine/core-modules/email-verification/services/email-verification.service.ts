...
import ms from 'ms';
import { SendEmailVerificationLinkEmail } from 'aegis-emails';
...
export class EmailVerificationService {
  ...
  async sendVerificationEmail({
    ...
    if (!this.aegisConfigService.get('IS_EMAIL_VERIFICATION_REQUIRED')) {
    ...
    const emailVerificationMsg =
      verificationTrigger === EmailVerificationTrigger.EMAIL_UPDATE
        ...
        : msg`Welcome to Aegis: Please Confirm Your Email`;
