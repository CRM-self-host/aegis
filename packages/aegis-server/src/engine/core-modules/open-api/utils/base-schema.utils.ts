...
`,
      termsOfService: 'https://github.com/u84u/aegis?tab=coc-ov-file#readme',
      contact: {
        email: 'felix@aegis.com',
      },
      license: {
        name: 'AGPL-3.0',
        url: 'https://github.com/u84u/aegis?tab=License-1-ov-file#readme',
      },
      version: API_Version,
    },
    // Testing purposes
    ...
    externalDocs: {
      description: 'Find out more about **Aegis**',
      url: 'https://aegis.com',
    },
