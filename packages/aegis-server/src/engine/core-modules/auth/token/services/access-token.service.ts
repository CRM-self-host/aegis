...
import ms from 'ms';
import { assertIsDefinedOrThrow } from 'aegis-shared/utils';
import { isWorkspaceActiveOrSuspended } from 'aegis-shared/workspace';
...
export class AccessTokenService {
  ...
  >): Promise<AuthToken> {
    const expiresIn = this.aegisConfigService.get('ACCESS_TOKEN_EXPIRES_IN');
