...
import ms from 'ms';
import { SendInviteLinkEmail } from 'aegis-emails';
import { AppPath, FileFolder } from 'aegis-shared/types';
...
export class WorkspaceInvitationService {
  ...
  async sendInvitations(
    ...
    for (const invitation of invitationResults) {
      if (invitation.status === 'fulfilled') {
        ...
        const joinTeamMsg = msg`Join your team on Aegis`;
  ...
  async generateInvitationToken(
    ...
    const expiresIn = this.aegisConfigService.get(
