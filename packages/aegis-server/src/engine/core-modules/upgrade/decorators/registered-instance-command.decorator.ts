...
import { type AegisAllVersion } from 'src/engine/core-modules/upgrade/constants/aegis-all-versions.constant';
...
// When dropping a version from AEGIS_CROSS_UPGRADE_SUPPORTED_VERSIONS, also
