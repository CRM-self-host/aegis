...
import { type ConfigVariablesMetadataMap } from 'src/engine/core-modules/aegis-config/decorators/config-variables-metadata.decorator';
...
import { typeTransformers } from 'src/engine/core-modules/aegis-config/utils/type-transformers.registry';
