import { trimAndRemoveDuplicatedWhitespacesFromObjectStringProperties } from 'aegis-shared/utils';
import { v4 } from 'uuid';
import { ViewFilterGroupLogicalOperator } from 'aegis-shared/types';
