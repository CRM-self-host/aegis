import { isDefined, removePropertiesFromRecord } from 'aegis-shared/utils';
...
export const fromObjectMetadataEntityToFlatObjectMetadata = ({
  ...
  if (isDefined(objectMetadataEntity.labelIdentifierFieldMetadataId)) {
    ...
    // TODO uncomment once https://github.com/u84u/core-team-issues/issues/2172 has been resolved
