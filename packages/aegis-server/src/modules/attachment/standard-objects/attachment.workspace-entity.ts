import { type ActorMetadata, FieldMetadataType } from 'aegis-shared/types';

import { type FileOutput } from 'src/engine/api/common/common-args-processors/data-arg-processor/types/file-item.type';
import { BaseWorkspaceEntity } from 'src/engine/aegis-orm/base.workspace-entity';
import { type CustomWorkspaceEntity } from 'src/engine/aegis-orm/custom.workspace-entity';
