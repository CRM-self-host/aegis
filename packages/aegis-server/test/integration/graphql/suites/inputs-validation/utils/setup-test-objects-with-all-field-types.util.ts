...
import { FieldMetadataType, RelationType } from 'aegis-shared/types';
import { computeMorphRelationFieldName } from 'aegis-shared/utils';
import { v4 } from 'uuid';
      ...
      data: [
        {
          ...
          linksField: {
            ...
            primaryLinkLabel: 'aegis - #1 Open source CRM',
            secondaryLinks: [
              {
                url: 'aegis.com',
                label: 'aegis - #1 Open source CRM',
              },
            ],
          },
          currencyField: {
