...
const AegisUiComponent = () => {
  const [count, setCount] = useState(0);

  return (
    <ThemeProvider colorScheme="light">
      <div data-testid="aegis-ui-component" style={CARD_STYLE}>
        <H2Title
          title="Aegis UI"
...
export default defineFrontComponent({
  ...
  name: 'aegis-ui-component',
  description: 'A front component using Aegis UI remote components',
  component: AegisUiComponent,
});
