...
const aegisUiTest: Story['play'] = async ({ canvasElement }) => {
  const canvas = within(canvasElement);

  await canvas.findByTestId('aegis-ui-component', {}, { timeout: 30000 });
...
export const AegisUiReact: Story = createComponentStory('aegis-ui-example', {
  play: aegisUiTest,
});
export const AegisUiPreact: Story = createComponentStory('aegis-ui-example', {
  runtime: 'preact',
  play: aegisUiTest,
});
