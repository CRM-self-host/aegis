...
export { AEGIS_STANDARD_APPLICATION_NAME } from './constants/AegisStandardApplicationName';
export { AEGIS_STANDARD_APPLICATION_UNIVERSAL_IDENTIFIER } from './constants/AegisStandardApplicationUniversalIdentifier';
