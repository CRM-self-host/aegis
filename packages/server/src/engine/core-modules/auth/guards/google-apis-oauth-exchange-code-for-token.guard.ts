...
export class GoogleAPIsOauthExchangeCodeForTokenGuard extends AuthGuard(
  ...
  async canActivate(context: ExecutionContext) {
    try {
      ...
      if (
        !this.aegisConfigService.get('MESSAGING_PROVIDER_GMAIL_ENABLED') &&
        !this.aegisConfigService.get('CALENDAR_PROVIDER_GOOGLE_ENABLED')
      ) {
      ...
      new GoogleAPIsOauthExchangeCodeForTokenStrategy(this.aegisConfigService);
