...
export const getSessionStorageOptions = (
  ...
  const SERVER_URL = aegisConfigService.get('SERVER_URL');

  const appSecret = aegisConfigService.get('APP_SECRET');
  ...
  switch (cacheStorageType) {
    ...
    case CacheStorageType.Redis: {
      const connectionString = aegisConfigService.get('REDIS_URL');
