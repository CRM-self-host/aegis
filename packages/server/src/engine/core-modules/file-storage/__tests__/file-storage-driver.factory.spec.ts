...
describe('FileStorageDriverFactory', () => {
  ...
  describe('buildConfigKey', () => {
    it('should build config key for local storage', () => {
      ...
      expect(aegisConfigService.get).toHaveBeenCalledWith('STORAGE_TYPE');
      expect(aegisConfigService.get).toHaveBeenCalledWith('STORAGE_LOCAL_PATH');
    });
    ...
    it('should throw error for unsupported storage type', () => {
      jest.spyOn(aegisConfigService, 'get').mockReturnValue('unsupported-type');
  ...
  describe('createDriver', () => {
    ...
    it('should throw error for invalid storage driver type', () => {
      jest.spyOn(aegisConfigService, 'get').mockReturnValue('invalid-type');
