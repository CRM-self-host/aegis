...
import { CONFIG_VARIABLES_MASKING_CONFIG } from 'src/engine/core-modules/aegis-config/constants/config-variables-masking-config';
import { type ConfigVariablesMetadataOptions } from 'src/engine/core-modules/aegis-config/decorators/config-variables-metadata.decorator';
import { DatabaseConfigDriver } from 'src/engine/core-modules/aegis-config/drivers/database-config.driver';
import { EnvironmentConfigDriver } from 'src/engine/core-modules/aegis-config/drivers/environment-config.driver';
import { ConfigSource } from 'src/engine/core-modules/aegis-config/enums/config-source.enum';
import { ConfigVariablesMaskingStrategies } from 'src/engine/core-modules/aegis-config/enums/config-variables-masking-strategies.enum';
import {
  ConfigVariableException,
  ConfigVariableExceptionCode,
} from 'src/engine/core-modules/aegis-config/aegis-config.exception';
import { configVariableMaskSensitiveData } from 'src/engine/core-modules/aegis-config/utils/config-variable-mask-sensitive-data.util';
import { isEnvOnlyConfigVar } from 'src/engine/core-modules/aegis-config/utils/is-env-only-config-var.util';
import { TypedReflect } from 'src/utils/typed-reflect';

@Injectable()
export class AegisConfigService {
  private readonly logger = new Logger(AegisConfigService.name);
