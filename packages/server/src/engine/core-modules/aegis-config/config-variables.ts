...
import { type AwsRegion } from 'src/engine/core-modules/aegis-config/interfaces/aws-region.interface';
...
import { CastToLogLevelArray } from 'src/engine/core-modules/aegis-config/decorators/cast-to-log-level-array.decorator';
import { CastToMeterDriverArray } from 'src/engine/core-modules/aegis-config/decorators/cast-to-meter-driver.decorator';
import { CastToPositiveNumber } from 'src/engine/core-modules/aegis-config/decorators/cast-to-positive-number.decorator';
import { CastToTypeORMLogLevelArray } from 'src/engine/core-modules/aegis-config/decorators/cast-to-typeorm-log-level-array.decorator';
import { CastToUpperSnakeCase } from 'src/engine/core-modules/aegis-config/decorators/cast-to-upper-snake-case.decorator';
import { ConfigVariablesMetadata } from 'src/engine/core-modules/aegis-config/decorators/config-variables-metadata.decorator';
import { IsAWSRegion } from 'src/engine/core-modules/aegis-config/decorators/is-aws-region.decorator';
import { IsDuration } from 'src/engine/core-modules/aegis-config/decorators/is-duration.decorator';
import { IsOptionalOrEmptyString } from 'src/engine/core-modules/aegis-config/decorators/is-optional-or-empty-string.decorator';
import { IsStrictlyLowerThan } from 'src/engine/core-modules/aegis-config/decorators/is-strictly-lower-than.decorator';
import { IsAegisSemVer } from 'src/engine/core-modules/aegis-config/decorators/is-aegis-semver.decorator';
import { ConfigVariableType } from 'src/engine/core-modules/aegis-config/enums/config-variable-type.enum';
import { ConfigVariablesGroup } from 'src/engine/core-modules/aegis-config/enums/config-variables-group.enum';
import {
  ConfigVariableException,
  ConfigVariableExceptionCode,
} from 'src/engine/core-modules/aegis-config/aegis-config.exception';
...
export class ConfigVariables {
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.ADVANCED_SETTINGS,
    description:
      "Enable or disable requests to aegis-icons to get companies' icons",
    type: ConfigVariableType.BOOLEAN,
  })
  ALLOW_REQUESTS_TO_AEGIS_ICONS = true;
  ...
  EMAIL_FROM_NAME = 'Felix from Aegis';
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.SERVER_CONFIG,
    description: 'Base URL for the Enterprise API on aegis.com',
    isHiddenInAdminPanel: true,
    type: ConfigVariableType.STRING,
  })
  @IsOptional()
  ENTERPRISE_API_URL: string = 'https://aegis.com/api/enterprise';
  ...
  @ConfigVariablesMetadata({
    group: ConfigVariablesGroup.SERVER_CONFIG,
    description: 'Aegis server version',
    type: ConfigVariableType.STRING,
    isEnvOnly: true,
    isHiddenInAdminPanel: true,
  })
