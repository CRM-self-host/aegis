...
const AegisConfigServiceGetAllMock = jest.fn();
const AegisConfigServiceGetVariableWithMetadataMock = jest.fn();
const mockHttpClientGet = jest.fn();
const mockGetHttpClient = jest.fn().mockReturnValue({ get: mockHttpClientGet });

jest.mock(
  'src/engine/core-modules/aegis-config/constants/config-variables-group-metadata',
  () => ({
...
describe('AdminPanelConfigService', () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        AdminPanelConfigService,
        {
          ...
          useValue: {
            getAll: AegisConfigServiceGetAllMock,
            getVariableWithMetadata:
              AegisConfigServiceGetVariableWithMetadataMock,
          },
        },
      ],
    }).compile();
  ...
  describe('getConfigVariablesGrouped', () => {
    it('should correctly group and sort config variables', () => {
      AegisConfigServiceGetAllMock.mockReturnValue({
        SERVER_URL: {
  ...
  describe('getConfigVariable', () => {
    it('should return config variable with all fields', () => {
      AegisConfigServiceGetVariableWithMetadataMock.mockReturnValue({
        value: 'test-value',
        metadata: {
          group: 'SERVER_CONFIG',
    ...
    it('should throw error when variable not found', () => {
      AegisConfigServiceGetVariableWithMetadataMock.mockReturnValue(undefined);
...
describe('AdminPanelVersionService', () => {
  ...
  describe('getVersionInfo', () => {
    ...
    beforeEach(() => {
      ...
      versionService['aegisConfigService'].get = mockEnvironmentGet;
    });
