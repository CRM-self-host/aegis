import { AUTO_SELECT_SMART_MODEL_ID } from 'shared/branding-constants';
...
} from 'src/engine/workspace-manager/aegis-standard-application/utils/agent-metadata/create-standard-agent-flat-metadata.util';
  ...
  helper: (args: Omit<CreateStandardAgentArgs, 'context'>) =>
    createStandardAgentFlatMetadata({
      ...
      context: {
        ...
        label: 'Helper',
        description:
          'AI agent specialized in helping users learn how to use Aegis CRM',
        icon: 'IconHelp',
        prompt: `You are a Helper Agent for Aegis. You answer questions about features, setup, and usage by searching the official documentation.
...
Always base answers on official Aegis documentation. Be patient and helpful.`,
