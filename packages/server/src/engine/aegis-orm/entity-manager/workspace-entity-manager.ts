...
import { type DeepPartialWithNestedRelationFields } from 'src/engine/aegis-orm/entity-manager/types/deep-partial-entity-with-nested-relation-fields.type';
import { type QueryDeepPartialEntityWithNestedRelationFields } from 'src/engine/aegis-orm/entity-manager/types/query-deep-partial-entity-with-nested-relation-fields.type';
import { getEntityTarget } from 'src/engine/aegis-orm/entity-manager/utils/get-entity-target';
import { computeAegisORMException } from 'src/engine/aegis-orm/error-handling/compute-aegis-orm-exception';
import { FilesFieldSync } from 'src/engine/aegis-orm/field-operations/files-field-sync/files-field-sync';
import { RelationNestedQueries } from 'src/engine/aegis-orm/field-operations/relation-nested-queries/relation-nested-queries';
import { type GlobalWorkspaceDataSource } from 'src/engine/aegis-orm/global-workspace-datasource/global-workspace-datasource';
import {
  type OperationType,
  validateOperationIsPermittedOrThrow,
} from 'src/engine/aegis-orm/repository/permissions.utils';
import { WorkspaceSelectQueryBuilder } from 'src/engine/aegis-orm/repository/workspace-select-query-builder';
import { WorkspaceRepository } from 'src/engine/aegis-orm/repository/workspace.repository';
import { getWorkspaceContext } from 'src/engine/aegis-orm/storage/orm-workspace-context.storage';
import { type RolePermissionConfig } from 'src/engine/aegis-orm/types/role-permission-config';
import { computePermissionIntersection } from 'src/engine/aegis-orm/utils/compute-permission-intersection.util';
import { formatData } from 'src/engine/aegis-orm/utils/format-data.util';
...
export class WorkspaceEntityManager extends EntityManager {
  ...
  >(
    ...
    try {
      ...
      throw await computeAegisORMException(
        error,
        objectMetadataItem,
        this,
        this.internalContext,
