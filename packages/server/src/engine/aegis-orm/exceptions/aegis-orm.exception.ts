...
export enum AegisORMExceptionCode {
...
const getAegisORMExceptionUserFriendlyMessage = (
  code: AegisORMExceptionCode,
) => {
  switch (code) {
    case AegisORMExceptionCode.METADATA_VERSION_MISMATCH:
      return msg`Data version mismatch. Please refresh and try again.`;
    case AegisORMExceptionCode.WORKSPACE_SCHEMA_NOT_FOUND:
      return msg`Workspace schema not found.`;
    case AegisORMExceptionCode.ROLES_PERMISSIONS_VERSION_NOT_FOUND:
      return msg`Roles and permissions configuration not found.`;
    case AegisORMExceptionCode.FEATURE_FLAG_MAP_VERSION_NOT_FOUND:
      return msg`Feature configuration not found.`;
    case AegisORMExceptionCode.USER_WORKSPACE_ROLE_MAP_VERSION_NOT_FOUND:
      return msg`User workspace role configuration not found.`;
    case AegisORMExceptionCode.API_KEY_ROLE_MAP_VERSION_NOT_FOUND:
      return msg`API key role configuration not found.`;
    case AegisORMExceptionCode.MALFORMED_METADATA:
      return msg`Data structure is invalid.`;
    case AegisORMExceptionCode.WORKSPACE_NOT_FOUND:
    ...
    case AegisORMExceptionCode.MISSING_MAIN_ALIAS_TARGET:
      return msg`Missing main alias target.`;
    case AegisORMExceptionCode.METHOD_NOT_ALLOWED:
      return msg`This operation is not allowed.`;
    case AegisORMExceptionCode.QUERY_READ_TIMEOUT:
    ...
    case AegisORMExceptionCode.ENUM_TYPE_NAME_NOT_FOUND:
    case AegisORMExceptionCode.ORM_EVENT_DATA_CORRUPTED:
      return STANDARD_ERROR_MESSAGE;
    case AegisORMExceptionCode.NO_ROLE_FOUND_FOR_USER_WORKSPACE:
...
export class AegisORMException extends CustomException<AegisORMExceptionCode> {
  constructor(
    message: string,
    code: AegisORMExceptionCode,
    ...
    super(message, code, {
      userFriendlyMessage:
        userFriendlyMessage ?? getAegisORMExceptionUserFriendlyMessage(code),
    });
  }
}
