import { type PerformAegisConfigQueryParams } from 'test/integration/aegis-config/types/perform-aegis-config-query.type';
...
export const deleteConfigVariable = async ({
  input,
  expectToFail = false,
}: PerformAegisConfigQueryParams<DeleteConfigVariableFactoryInput>) => {
