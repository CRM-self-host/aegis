# Postcard App — Aegis App Example

A rich example app showcasing all Aegis app entity types. Use this as a reference when building your own apps.

## What's included

This app demonstrates every entity type available in the Aegis SDK:
...
| **Front Components** | `src/components/` | React components rendered inside Aegis's UI |
...
Or use it as a template via create-aegis-app:

```bash
npx create-aegis-app@latest my-app --example postcard
```

## Learn more

- [Getting Started](https://docs.aegis.com/developers/extend/apps/getting-started)
- [Building Apps](https://docs.aegis.com/developers/extend/apps/building)
- [Publishing](https://docs.aegis.com/developers/extend/apps/publishing)
