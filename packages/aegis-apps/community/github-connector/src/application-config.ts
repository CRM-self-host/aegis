...
export default defineApplication({
  ...
  applicationVariables: {
    ...
    GITHUB_REPOS: {
      ...
      description:
        'Comma-separated list of `owner/repo` to sync (e.g. `u84u/aegis,octo/hello`). Used by the manual fetch routes.',
      isSecret: false,
    },
    GITHUB_PROJECTS: {
      universalIdentifier: 'e3a8c7d2-4b95-4e1f-8a6c-9d2b5f7e1c84',
      description:
        'Comma-separated list of GitHub Projects (v2) to sync. Each entry is `owner/number` (e.g. `u84u/24,octo/3`). Owner can be an organization or a user. Full URLs like `https://github.com/orgs/u84u/projects/24` or `https://github.com/users/octo/projects/3` are also accepted.',
      isSecret: false,
    },
  },
});
