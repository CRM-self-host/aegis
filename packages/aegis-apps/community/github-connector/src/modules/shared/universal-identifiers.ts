...
export const APP_DESCRIPTION =
  'Sync pull requests, reviews, issues, contributors and Projects (v2) items from GitHub into Aegis.';
export const APP_ABOUT_DESCRIPTION = [
  'Bring your GitHub activity into Aegis as native records you can view, filter, group and report on alongside the rest of your CRM data.',
  '',
  '**What gets synced**',
