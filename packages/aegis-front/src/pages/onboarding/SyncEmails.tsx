...
import { ModalContent } from 'aegis-ui/layout';
import { useHotkeysOnFocusedElement } from '@/ui/utilities/hotkey/hooks/useHotkeysOnFocusedElement';
import { t } from '@lingui/core/macro';
import { AppPath, ConnectedAccountProvider } from 'aegis-shared/types';
import { IconGoogle, IconMicrosoft } from 'aegis-ui/display';
import { MainButton } from 'aegis-ui/input';
import { ClickToActionLink } from 'aegis-ui/navigation';
...
export const SyncEmails = () => {
  ...
  return (
    <ModalContent isVerticallyCentered isHorizontallyCentered>
      ...
      <SubTitle>
        {t`Sync your Emails and Calendar with Aegis. Choose your privacy settings.`}
      </SubTitle>
