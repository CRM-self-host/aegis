...
import { CoreObjectNameSingular, AppPath } from 'aegis-shared/types';
...
import { IconBrowserMaximize } from 'aegis-ui/display';
import { Button } from 'aegis-ui/input';
import { getOsControlSymbol } from 'aegis-ui/utilities';
