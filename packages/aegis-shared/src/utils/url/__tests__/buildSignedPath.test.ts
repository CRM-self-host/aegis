...
describe('buildSignedPath', () => {
  ...
  it('should ignore absolute https urls', () => {
    expect(
      buildSignedPath({
        path: 'https://u84u.github.io/placeholder-images/workspaces/aegis-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'https://u84u.github.io/placeholder-images/workspaces/aegis-logo.png',
    );
  });
  ...
  it('should ignore absolute http urls', () => {
    expect(
      buildSignedPath({
        path: 'http://u84u.github.io/placeholder-images/workspaces/aegis-logo.png',
        token: 'tokenValue',
      }),
    ).toBe(
      'http://u84u.github.io/placeholder-images/workspaces/aegis-logo.png',
    );
  });
});
