...
const PACKAGE_TAG_MAP: Record<string, string[]> = {
  'aegis-front': ['scope:frontend'],
  'aegis-server': ['scope:backend'],
  'aegis-ui': ['scope:shared'],
  'aegis-shared': ['scope:shared'],
  'aegis-emails': ['scope:backend'],
  'aegis-sdk': ['scope:sdk', 'scope:shared'],
  'aegis-zapier': ['scope:zapier'],
  'aegis-oxlint-rules': ['scope:shared'],
  'aegis-docs': ['scope:docs'],
  'aegis-website': ['scope:docs'],
  'aegis-e2e-testing': ['scope:testing'],
  'create-aegis-app': ['scope:create-app'],
};
